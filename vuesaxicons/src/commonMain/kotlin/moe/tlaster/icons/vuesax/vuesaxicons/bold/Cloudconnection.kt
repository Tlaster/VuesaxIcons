...
public val BoldGroup.Cloudconnection: ImageVector
    get() {
        ...
        _cloudconnection = Builder(name = "Cloudconnection", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(19.2007f, 14.7811f)
                curveTo(18.3407f, 15.5711f, 17.2007f, 16.0111f, 16.0307f, 16.0011f)
                horizontalLineTo(6.3707f)
                curveTo(2.3007f, 15.7111f, 2.2907f, 9.8011f, 6.3707f, 9.5111f)
                horizontalLineTo(6.4107f)
                curveTo(3.6207f, 1.7511f, 15.4107f, -1.3389f, 16.7607f, 6.8011f)
                curveTo(20.5307f, 7.2811f, 22.0607f, 12.2911f, 19.2007f, 14.7811f)
                close()
            }
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
