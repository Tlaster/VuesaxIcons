...
public val BoldGroup.Timer1: ImageVector
    get() {
        if (_timer1 != null) {
            return _timer1!!
        }
        _timer1 = Builder(name = "Timer1", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(17.3895f, 15.67f)
                lineTo(13.3495f, 12.0f)
                horizontalLineTo(10.6395f)
                lineTo(6.5995f, 15.67f)
                curveTo(5.4695f, 16.69f, 5.0995f, 18.26f, 5.6495f, 19.68f)
                curveTo(6.1995f, 21.09f, 7.5395f, 22.0f, 9.0495f, 22.0f)
                horizontalLineTo(14.9395f)
                curveTo(16.4595f, 22.0f, 17.7895f, 21.09f, 18.3395f, 19.68f)
                curveTo(18.8895f, 18.26f, 18.5195f, 16.69f, 17.3895f, 15.67f)
                close()
                moveTo(13.8195f, 18.14f)
                horizontalLineTo(10.1795f)
                curveTo(9.7995f, 18.14f, 9.4995f, 17.83f, 9.4995f, 17.46f)
                curveTo(9.4995f, 17.09f, 9.8095f, 16.78f, 10.1795f, 16.78f)
                horizontalLineTo(13.8195f)
                curveTo(14.1995f, 16.78f, 14.4995f, 17.09f, 14.4995f, 17.46f)
                curveTo(14.4995f, 17.83f, 14.1895f, 18.14f, 13.8195f, 18.14f)
                close()
            }
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
