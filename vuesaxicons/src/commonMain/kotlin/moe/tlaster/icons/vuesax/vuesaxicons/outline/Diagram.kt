...
public val OutlineGroup.Diagram: ImageVector
    get() {
        if (_diagram != null) {
            return _diagram!!
        }
        _diagram = Builder(name = "Diagram", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(14.2498f, 12.1898f, 14.5798f, 12.3098f, 14.9298f, 12.3098f)
                ...
                curveTo(14.2298f, 13.8298f, 13.4798f, 13.5498f, 12.9398f, 13.0098f)
