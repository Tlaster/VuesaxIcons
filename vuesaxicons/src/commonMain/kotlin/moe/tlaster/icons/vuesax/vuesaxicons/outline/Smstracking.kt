...
public val OutlineGroup.Smstracking: ImageVector
    get() {
        ...
        _smstracking = Builder(name = "Smstracking", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(6.25f, 20.09f, 6.59f, 19.75f, 7.0f, 19.75f)
                ...
                curveTo(2.75f, 8.91f, 2.41f, 9.25f, 2.0f, 9.25f)
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(1.25f, 16.09f, 1.59f, 15.75f, 2.0f, 15.75f)
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(1.25f, 12.09f, 1.59f, 11.75f, 2.0f, 11.75f)
                horizontalLineTo(5.0f)
                curveTo(5.41f, 11.75f, 5.75f, 12.09f, 5.75f, 12.5f)
                curveTo(5.75f, 12.91f, 5.41f, 13.25f, 5.0f, 13.25f)
                close()
            }
        }
        .build()
