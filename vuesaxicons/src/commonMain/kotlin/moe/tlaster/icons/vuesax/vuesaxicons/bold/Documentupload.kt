...
public val BoldGroup.Documentupload: ImageVector
    get() {
        if (_documentupload != null) {
            return _documentupload!!
        }
        _documentupload = Builder(name = "Documentupload", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(11.38f, 13.68f, 11.19f, 13.75f, 11.0f, 13.75f)
                curveTo(10.81f, 13.75f, 10.62f, 13.68f, 10.47f, 13.53f)
                lineTo(9.75f, 12.81f)
                verticalLineTo(17.0f)
                curveTo(9.75f, 17.41f, 9.41f, 17.75f, 9.0f, 17.75f)
                curveTo(8.59f, 17.75f, 8.25f, 17.41f, 8.25f, 17.0f)
                ...
                curveTo(8.98f, 10.25f, 9.0f, 10.25f, 9.03f, 10.25f)
