...
public val TwotoneGroup.Hierarchy2: ImageVector
    get() {
        if (_hierarchy2 != null) {
            return _hierarchy2!!
        }
        _hierarchy2 = Builder(name = "Hierarchy2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    ...
                    Round, strokeLineJoin = StrokeJoin.Companion.Round, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(5.1289f, 15.0f)
                curveTo(5.5789f, 13.25f, 7.1789f, 11.95f, 9.0689f, 11.96f)
                lineTo(12.4989f, 11.97f)
                curveTo(15.1189f, 11.98f, 17.3489f, 10.3f, 18.1689f, 7.96f)
            }
        }
        .build()
        return _hierarchy2!!
