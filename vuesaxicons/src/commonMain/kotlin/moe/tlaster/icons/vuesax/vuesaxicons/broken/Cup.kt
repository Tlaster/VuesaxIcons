...
public val BrokenGroup.Cup: ImageVector
    get() {
        if (_cup != null) {
            return _cup!!
        }
        _cup = Builder(name = "Cup", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp, viewportWidth
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    ...
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(8.51f, 15.07f)
                curveTo(6.41f, 13.86f, 5.0f, 11.6f, 5.0f, 9.0f)
                verticalLineTo(6.0f)
                curveTo(5.0f, 3.79f, 6.79f, 2.0f, 9.0f, 2.0f)
                horizontalLineTo(15.0f)
                curveTo(17.21f, 2.0f, 19.0f, 3.79f, 19.0f, 6.0f)
                verticalLineTo(9.0f)
                curveTo(19.0f, 12.82f, 15.95f, 15.92f, 12.15f, 16.0f)
                curveTo(12.1f, 16.0f, 12.0f, 16.0f, 12.0f, 16.0f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
