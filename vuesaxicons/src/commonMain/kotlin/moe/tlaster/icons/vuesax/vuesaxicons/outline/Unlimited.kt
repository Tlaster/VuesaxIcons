...
public val OutlineGroup.Unlimited: ImageVector
    get() {
        if (_unlimited != null) {
            return _unlimited!!
        }
        _unlimited = Builder(name = "Unlimited", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(10.3102f, 16.2399f, 8.4803f, 17.27f, 6.5402f, 17.27f)
                curveTo(3.6202f, 17.27f, 1.2402f, 14.8899f, 1.2402f, 11.9699f)
                curveTo(1.2402f, 9.0499f, 3.6202f, 6.6699f, 6.5402f, 6.6699f)
                curveTo(8.2203f, 6.6699f, 9.7702f, 7.4599f, 10.7802f, 8.8499f)
                curveTo(11.0202f, 9.1799f, 10.9502f, 9.65f, 10.6202f, 9.9f)
                curveTo(10.2802f, 10.14f, 9.8202f, 10.0699f, 9.5702f, 9.7399f)
                curveTo(8.8403f, 8.7499f, 7.7403f, 8.1799f, 6.5402f, 8.1799f)
                curveTo(4.4503f, 8.1799f, 2.7402f, 9.8799f, 2.7402f, 11.9799f)
                curveTo(2.7402f, 14.0799f, 4.4402f, 15.78f, 6.5402f, 15.78f)
                curveTo(7.9602f, 15.78f, 9.3002f, 15.0199f, 10.0302f, 13.8099f)
                lineTo(12.6802f, 9.4f)
                curveTo(13.6802f, 7.73f, 15.5103f, 6.7f, 17.4503f, 6.7f)
                curveTo(20.3703f, 6.7f, 22.7502f, 9.0799f, 22.7502f, 11.9999f)
