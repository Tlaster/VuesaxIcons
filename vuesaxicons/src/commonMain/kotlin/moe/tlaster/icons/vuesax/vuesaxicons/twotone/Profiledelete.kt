...
public val TwotoneGroup.Profiledelete: ImageVector
    get() {
        ...
        _profiledelete = Builder(name = "Profiledelete", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                moveTo(18.4098f, 18.0898f)
                lineTo(15.5898f, 20.9098f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    fillAlpha = 0.4f, strokeAlpha = 0.4f, strokeLineWidth = 1.5f, strokeLineCap =
                    Round, strokeLineJoin = StrokeJoin.Companion.Round, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(18.4098f, 20.9098f)
                lineTo(15.5898f, 18.0898f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    fillAlpha = 0.4f, strokeAlpha = 0.4f, strokeLineWidth = 1.5f, strokeLineCap =
                    Round, strokeLineJoin = StrokeJoin.Companion.Round, strokeLineMiter = 4.0f,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                moveTo(12.0008f, 21.8102f)
                curveTo(10.1808f, 21.8102f, 8.3708f, 21.3502f, 6.9908f, 20.4302f)
                curveTo(4.5708f, 18.8102f, 4.5708f, 16.1702f, 6.9908f, 14.5602f)
                curveTo(9.7408f, 12.7202f, 14.2508f, 12.7202f, 17.0008f, 14.5602f)
            }
        }
        .build()
        return _profiledelete!!
