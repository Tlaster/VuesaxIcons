...
public val BulkGroup.Money2: ImageVector
    get() {
        if (_money2 != null) {
            return _money2!!
        }
        _money2 = Builder(name = "Money2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, fillAlpha = 0.4f, strokeAlpha
                ...
                curveTo(7.0f, 16.0f, 6.0f, 15.0f, 3.0f, 15.0f)
                ...
                verticalLineTo(5.0f)
                curveTo(17.0f, 8.0f, 18.0f, 9.0f, 21.0f, 9.0f)
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(7.0f, 3.5f)
                verticalLineTo(5.0f)
                curveTo(7.0f, 8.0f, 6.0f, 9.0f, 3.0f, 9.0f)
                horizontalLineTo(2.0f)
                verticalLineTo(8.5f)
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(19.0f)
                curveTo(17.0f, 16.0f, 18.0f, 15.0f, 21.0f, 15.0f)
                horizontalLineTo(22.0f)
                close()
            }
        }
