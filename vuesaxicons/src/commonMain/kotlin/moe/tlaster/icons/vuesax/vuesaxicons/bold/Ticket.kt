    ...
    get() {
        ...
        _ticket = Builder(name = "Ticket", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(22.0f, 10.75f)
                curveTo(22.41f, 10.75f, 22.75f, 10.41f, 22.75f, 10.0f)
                verticalLineTo(9.0f)
                curveTo(22.75f, 4.59f, 21.41f, 3.25f, 17.0f, 3.25f)
                horizontalLineTo(10.75f)
                verticalLineTo(5.5f)
                curveTo(10.75f, 5.91f, 10.41f, 6.25f, 10.0f, 6.25f)
                ...
                curveTo(21.41f, 20.75f, 22.75f, 19.41f, 22.75f, 15.0f)
                curveTo(22.75f, 14.59f, 22.41f, 14.25f, 22.0f, 14.25f)
                curveTo(21.04f, 14.25f, 20.25f, 13.46f, 20.25f, 12.5f)
                curveTo(20.25f, 11.54f, 21.04f, 10.75f, 22.0f, 10.75f)
                close()
                moveTo(10.75f, 14.17f)
                curveTo(10.75f, 14.58f, 10.41f, 14.92f, 10.0f, 14.92f)
