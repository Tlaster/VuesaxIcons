...
public val TwotoneGroup.Wallet3: ImageVector
    get() {
        if (_wallet3 != null) {
            return _wallet3!!
        }
        _wallet3 = Builder(name = "Wallet3", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    ...
                    Round, strokeLineJoin = StrokeJoin.Companion.Round, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(2.0f, 11.1498f)
                verticalLineTo(6.5299f)
                curveTo(2.0f, 4.4899f, 3.65f, 2.8398f, 5.69f, 2.8398f)
                horizontalLineTo(11.31f)
                curveTo(13.35f, 2.8398f, 15.0f, 4.1098f, 15.0f, 6.1498f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
