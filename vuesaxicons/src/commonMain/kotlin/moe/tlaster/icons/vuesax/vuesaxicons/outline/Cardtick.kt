...
public val OutlineGroup.Cardtick: ImageVector
    get() {
        if (_cardtick != null) {
            return _cardtick!!
        }
        _cardtick = Builder(name = "Cardtick", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(17.9995f, 8.2499f)
                curveTo(17.8095f, 8.2499f, 17.6195f, 8.1799f, 17.4695f, 8.0299f)
                lineTo(15.9695f, 6.5299f)
                curveTo(15.6795f, 6.2399f, 15.6795f, 5.7599f, 15.9695f, 5.4699f)
                curveTo(16.2595f, 5.1799f, 16.7395f, 5.1799f, 17.0295f, 5.4699f)
                lineTo(17.9995f, 6.4399f)
                lineTo(21.4695f, 2.9699f)
                curveTo(21.7595f, 2.6799f, 22.2395f, 2.6799f, 22.5295f, 2.9699f)
                curveTo(22.8195f, 3.2599f, 22.8195f, 3.7399f, 22.5295f, 4.0299f)
                lineTo(18.5295f, 8.0299f)
                curveTo(18.3795f, 8.1799f, 18.1895f, 8.2499f, 17.9995f, 8.2499f)
                close()
            }
        }
        .build()
