...
public val BoldGroup.Musicplay: ImageVector
    get() {
        if (_musicplay != null) {
            return _musicplay!!
        }
        _musicplay = Builder(name = "Musicplay", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(13.1807f, 11.8606f)
                curveTo(12.7807f, 11.8606f, 12.4207f, 11.6406f, 12.2507f, 11.2806f)
                lineTo(10.8007f, 8.3906f)
                lineTo(10.3807f, 9.1706f)
                curveTo(10.1507f, 9.6006f, 9.6907f, 9.8706f, 9.2007f, 9.8706f)
                horizontalLineTo(8.4707f)
                curveTo(8.0607f, 9.8706f, 7.7207f, 9.5306f, 7.7207f, 9.1206f)
                curveTo(7.7207f, 8.7106f, 8.0607f, 8.3706f, 8.4707f, 8.3706f)
                horizontalLineTo(9.1107f)
                lineTo(9.9007f, 6.9106f)
                curveTo(10.0907f, 6.5706f, 10.4707f, 6.3406f, 10.8307f, 6.3606f)
                curveTo(11.2207f, 6.3606f, 11.5707f, 6.5906f, 11.7507f, 6.9306f)
                lineTo(13.1807f, 9.7906f)
                lineTo(13.5207f, 9.1006f)
                curveTo(13.7507f, 8.6406f, 14.2007f, 8.3606f, 14.7207f, 8.3606f)
                horizontalLineTo(15.5307f)
                curveTo(15.9407f, 8.3606f, 16.2807f, 8.7006f, 16.2807f, 9.1106f)
                curveTo(16.2807f, 9.5206f, 15.9407f, 9.8606f, 15.5307f, 9.8606f)
                horizontalLineTo(14.8207f)
                lineTo(14.1107f, 11.2706f)
                curveTo(13.9307f, 11.6406f, 13.5807f, 11.8606f, 13.1807f, 11.8606f)
                close()
            }
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
