...
public val BrokenGroup.Cameraslash: ImageVector
    get() {
        ...
        _cameraslash = Builder(name = "Cameraslash", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(6.7598f, 22.0f)
                horizontalLineTo(17.2398f)
                curveTo(19.9998f, 22.0f, 21.0998f, 20.31f, 21.2298f, 18.25f)
                lineTo(21.7498f, 9.99f)
                curveTo(21.8098f, 9.06f, 21.5198f, 8.19f, 21.0098f, 7.51f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(2.7695f, 18.25f)
                curveTo(2.8195f, 19.07f, 3.0295f, 19.84f, 3.4395f, 20.46f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
