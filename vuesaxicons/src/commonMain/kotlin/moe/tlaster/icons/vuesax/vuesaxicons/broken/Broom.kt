...
public val BrokenGroup.Broom: ImageVector
    get() {
        if (_broom != null) {
            return _broom!!
        }
        _broom = Builder(name = "Broom", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(9.1991f, 20.4401f)
                curveTo(9.8591f, 21.7901f, 11.4591f, 22.26f, 12.7391f, 21.47f)
                lineTo(19.1691f, 17.5601f)
                curveTo(20.4591f, 16.7801f, 20.7691f, 15.1501f, 19.8791f, 13.9401f)
                lineTo(17.1091f, 10.2001f)
                curveTo(15.9091f, 8.5901f, 13.6491f, 8.04f, 11.8191f, 9.1601f)
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(10.7574f, 5.0979f)
                lineTo(5.6328f, 8.2185f)
                lineTo(7.7132f, 11.6349f)
                lineTo(12.8378f, 8.5143f)
                lineTo(10.7574f, 5.0979f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
