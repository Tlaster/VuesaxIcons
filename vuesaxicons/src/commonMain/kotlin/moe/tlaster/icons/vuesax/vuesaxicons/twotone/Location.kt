...
public val TwotoneGroup.Location: ImageVector
    get() {
        if (_location != null) {
            return _location!!
        }
        _location = Builder(name = "Location", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                moveTo(12.0009f, 13.4299f)
                curveTo(13.724f, 13.4299f, 15.1209f, 12.0331f, 15.1209f, 10.3099f)
                curveTo(15.1209f, 8.5868f, 13.724f, 7.1899f, 12.0009f, 7.1899f)
                curveTo(10.2777f, 7.1899f, 8.8809f, 8.5868f, 8.8809f, 10.3099f)
                curveTo(8.8809f, 12.0331f, 10.2777f, 13.4299f, 12.0009f, 13.4299f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
