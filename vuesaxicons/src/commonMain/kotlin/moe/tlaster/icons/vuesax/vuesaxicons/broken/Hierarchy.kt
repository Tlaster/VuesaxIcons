...
public val BrokenGroup.Hierarchy: ImageVector
    get() {
        if (_hierarchy != null) {
            return _hierarchy!!
        }
        _hierarchy = Builder(name = "Hierarchy", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    ...
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(5.1309f, 9.0f)
                curveTo(5.5809f, 10.75f, 7.1809f, 12.05f, 9.0709f, 12.04f)
                lineTo(12.5009f, 12.03f)
                curveTo(13.3409f, 12.03f, 14.1309f, 12.2f, 14.8609f, 12.5f)
            }
        }
        .build()
        return _hierarchy!!
