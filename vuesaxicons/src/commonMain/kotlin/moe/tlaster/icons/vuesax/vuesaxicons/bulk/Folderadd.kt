...
public val BulkGroup.Folderadd: ImageVector
    get() {
        if (_folderadd != null) {
            return _folderadd!!
        }
        _folderadd = Builder(name = "Folderadd", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(14.5f, 16.2499f)
                horizontalLineTo(12.81f)
                verticalLineTo(17.9999f)
                curveTo(12.81f, 18.4099f, 12.47f, 18.7499f, 12.06f, 18.7499f)
                curveTo(11.65f, 18.7499f, 11.31f, 18.4099f, 11.31f, 17.9999f)
                verticalLineTo(16.2499f)
                horizontalLineTo(9.5f)
                curveTo(9.09f, 16.2499f, 8.75f, 15.9099f, 8.75f, 15.4999f)
                curveTo(8.75f, 15.0899f, 9.09f, 14.7499f, 9.5f, 14.7499f)
                horizontalLineTo(11.31f)
                verticalLineTo(12.9999f)
                curveTo(11.31f, 12.5899f, 11.65f, 12.2499f, 12.06f, 12.2499f)
                curveTo(12.47f, 12.2499f, 12.81f, 12.5899f, 12.81f, 12.9999f)
                verticalLineTo(14.7499f)
                horizontalLineTo(14.5f)
                curveTo(14.91f, 14.7499f, 15.25f, 15.0899f, 15.25f, 15.4999f)
                curveTo(15.25f, 15.9099f, 14.91f, 16.2499f, 14.5f, 16.2499f)
                close()
            }
        }
        .build()
