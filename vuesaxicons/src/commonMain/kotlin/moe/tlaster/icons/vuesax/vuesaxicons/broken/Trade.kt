...
public val BrokenGroup.Trade: ImageVector
    get() {
        if (_trade != null) {
            return _trade!!
        }
        _trade = Builder(name = "Trade", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(18.4097f, 22.0f)
                horizontalLineTo(20.9997f)
                curveTo(21.5497f, 22.0f, 21.9997f, 21.55f, 21.9997f, 21.0f)
                verticalLineTo(18.41f)
                curveTo(21.9997f, 17.52f, 20.9197f, 17.07f, 20.2897f, 17.7f)
                lineTo(17.6997f, 20.29f)
                curveTo(17.0797f, 20.92f, 17.5197f, 22.0f, 18.4097f, 22.0f)
                close()
            }
        }
        .build()
