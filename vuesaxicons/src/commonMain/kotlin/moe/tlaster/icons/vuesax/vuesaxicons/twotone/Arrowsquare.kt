...
public val TwotoneGroup.Arrowsquare: ImageVector
    get() {
        ...
        _arrowsquare = Builder(name = "Arrowsquare", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    ...
                    Round, strokeLineJoin = StrokeJoin.Companion.Round, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(5.6211f, 8.5498f)
                horizontalLineTo(7.5811f)
                curveTo(10.1011f, 8.5498f, 12.1511f, 10.5898f, 12.1511f, 13.1198f)
                verticalLineTo(13.7698f)
