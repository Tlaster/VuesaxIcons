...
public val BrokenGroup.Headphone: ImageVector
    get() {
        if (_headphone != null) {
            return _headphone!!
        }
        _headphone = Builder(name = "Headphone", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                curveTo(5.46f, 14.6f, 6.22f, 13.73f, 7.3f, 13.73f)
                curveTo(8.27f, 13.73f, 9.14f, 14.49f, 9.14f, 15.57f)
                verticalLineTo(18.38f)
                curveTo(9.14f, 20.33f, 7.52f, 21.95f, 5.57f, 21.95f)
                curveTo(3.62f, 21.95f, 2.0f, 20.32f, 2.0f, 18.38f)
