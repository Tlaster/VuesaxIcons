...
public val TwotoneGroup.Clock: ImageVector
    get() {
        if (_clock != null) {
            return _clock!!
        }
        _clock = Builder(name = "Clock", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                moveTo(15.7099f, 15.1798f)
                lineTo(12.6099f, 13.3298f)
                curveTo(12.0699f, 13.0098f, 11.6299f, 12.2398f, 11.6299f, 11.6098f)
