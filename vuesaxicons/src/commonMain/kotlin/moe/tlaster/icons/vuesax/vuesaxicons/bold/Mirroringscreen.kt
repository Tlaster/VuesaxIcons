...
public val BoldGroup.Mirroringscreen: ImageVector
    get() {
        ...
        _mirroringscreen = Builder(name = "Mirroringscreen", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(4.24f, 3.0f, 2.0f, 5.24f, 2.0f, 8.0f)
                verticalLineTo(9.0f)
                verticalLineTo(16.0f)
                curveTo(2.0f, 18.76f, 4.24f, 21.0f, 7.0f, 21.0f)
                horizontalLineTo(16.0f)
                horizontalLineTo(17.0f)
                curveTo(19.76f, 21.0f, 22.0f, 18.76f, 22.0f, 16.0f)
                verticalLineTo(8.0f)
                curveTo(22.0f, 5.24f, 19.76f, 3.0f, 17.0f, 3.0f)
                close()
