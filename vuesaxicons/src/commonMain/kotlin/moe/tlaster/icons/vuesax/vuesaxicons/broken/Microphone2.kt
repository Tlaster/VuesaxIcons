...
public val BrokenGroup.Microphone2: ImageVector
    get() {
        ...
        _microphone2 = Builder(name = "Microphone2", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(4.3496f, 9.6499f)
                verticalLineTo(11.3499f)
                curveTo(4.3496f, 15.5699f, 7.7796f, 18.9999f, 11.9996f, 18.9999f)
                curveTo(16.2196f, 18.9999f, 19.6496f, 15.5699f, 19.6496f, 11.3499f)
