...
public val BrokenGroup.Walletsearch: ImageVector
    get() {
        ...
        _walletsearch = Builder(name = "Walletsearch", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(16.7992f, 4.7998f)
                curveTo(17.3992f, 5.3998f, 17.6992f, 6.1999f, 17.7992f, 6.9999f)
                curveTo(17.5992f, 6.9999f, 17.2992f, 6.9999f, 16.9992f, 6.9999f)
                horizontalLineTo(6.9992f)
                curveTo(6.6992f, 6.9999f, 6.4992f, 6.9998f, 6.1992f, 7.0998f)
                curveTo(6.2992f, 6.7998f, 6.4992f, 6.5999f, 6.7992f, 6.2998f)
                lineTo(9.9992f, 2.9999f)
                curveTo(10.8192f, 2.1799f, 11.9092f, 1.8398f, 12.9592f, 1.9798f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
