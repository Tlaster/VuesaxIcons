...
public val BrokenGroup.Command: ImageVector
    get() {
        if (_command != null) {
            return _command!!
        }
        _command = Builder(name = "Command", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(2.1699f, 19.99f)
                curveTo(2.5799f, 21.16f, 3.6999f, 22.0f, 4.9999f, 22.0f)
                curveTo(6.6499f, 22.0f, 7.9999f, 20.65f, 7.9999f, 19.0f)
                verticalLineTo(16.0f)
