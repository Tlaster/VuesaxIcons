...
public val BrokenGroup.Shop: ImageVector
    get() {
        if (_shop != null) {
            return _shop!!
        }
        _shop = Builder(name = "Shop", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                moveTo(3.0098f, 15.71f)
                curveTo(3.0098f, 20.2f, 4.8098f, 22.0f, 9.2998f, 22.0f)
                horizontalLineTo(14.6898f)
                curveTo(19.1798f, 22.0f, 20.9798f, 20.2f, 20.9798f, 15.71f)
