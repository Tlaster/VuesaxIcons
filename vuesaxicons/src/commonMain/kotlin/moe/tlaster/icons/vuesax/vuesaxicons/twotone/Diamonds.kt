...
public val TwotoneGroup.Diamonds: ImageVector
    get() {
        if (_diamonds != null) {
            return _diamonds!!
        }
        _diamonds = Builder(name = "Diamonds", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                lineTo(21.2105f, 13.2199f)
                curveTo(21.9805f, 12.3699f, 22.2304f, 10.8299f, 21.7604f, 9.7899f)
                lineTo(19.2004f, 4.0299f)
