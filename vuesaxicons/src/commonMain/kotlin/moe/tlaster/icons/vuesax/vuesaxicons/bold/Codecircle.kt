...
public val BoldGroup.Codecircle: ImageVector
    get() {
        if (_codecircle != null) {
            return _codecircle!!
        }
        _codecircle = Builder(name = "Codecircle", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.38f, 14.68f, 8.19f, 14.75f, 8.0f, 14.75f)
                ...
                curveTo(11.57f, 14.91f, 11.29f, 15.08f, 11.0f, 15.08f)
                ...
                curveTo(16.38f, 14.68f, 16.19f, 14.75f, 16.0f, 14.75f)
