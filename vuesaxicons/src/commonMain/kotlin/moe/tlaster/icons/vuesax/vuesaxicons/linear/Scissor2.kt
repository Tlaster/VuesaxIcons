...
public val LinearGroup.Scissor2: ImageVector
    get() {
        if (_scissor2 != null) {
            return _scissor2!!
        }
        _scissor2 = Builder(name = "Scissor2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(17.4999f, 8.7f)
                lineTo(10.1599f, 14.19f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(17.4999f, 15.28f)
                lineTo(10.1599f, 9.79f)
            }
        }
        .build()
        return _scissor2!!
...
private var _scissor2: ImageVector? = null
