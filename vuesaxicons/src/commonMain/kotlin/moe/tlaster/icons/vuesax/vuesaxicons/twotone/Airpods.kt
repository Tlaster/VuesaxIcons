...
public val TwotoneGroup.Airpods: ImageVector
    get() {
        if (_airpods != null) {
            return _airpods!!
        }
        _airpods = Builder(name = "Airpods", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                moveTo(5.7799f, 6.7198f)
                curveTo(5.2599f, 6.7198f, 4.8398f, 6.2998f, 4.8398f, 5.7799f)
                curveTo(4.8398f, 5.2599f, 5.2599f, 4.8398f, 5.7799f, 4.8398f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    ...
                    Round, strokeLineJoin = StrokeJoin.Companion.Round, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(18.2197f, 6.7198f)
                curveTo(18.7397f, 6.7198f, 19.1597f, 6.2998f, 19.1597f, 5.7799f)
                curveTo(19.1597f, 5.2599f, 18.7397f, 4.8398f, 18.2197f, 4.8398f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    fillAlpha = 0.4f, strokeAlpha = 0.4f, strokeLineWidth = 1.5f, strokeLineCap =
                    Round, strokeLineJoin = StrokeJoin.Companion.Round, strokeLineMiter = 4.0f,
