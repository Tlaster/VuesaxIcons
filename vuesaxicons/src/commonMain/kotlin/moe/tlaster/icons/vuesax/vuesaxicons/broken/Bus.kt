...
public val BrokenGroup.Bus: ImageVector
    get() {
        if (_bus != null) {
            return _bus!!
        }
        _bus = Builder(name = "Bus", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp, viewportWidth
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                curveTo(20.0f, 20.6f, 18.61f, 22.0f, 16.9f, 22.0f)
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                verticalLineTo(9.5f)
                curveTo(20.0f, 8.67f, 19.33f, 8.0f, 18.5f, 8.0f)
                horizontalLineTo(5.5f)
                curveTo(4.67f, 8.0f, 4.0f, 8.67f, 4.0f, 9.5f)
                verticalLineTo(11.5f)
                curveTo(4.0f, 12.33f, 4.67f, 13.0f, 5.5f, 13.0f)
