...
public val BrokenGroup.Airpods: ImageVector
    get() {
        if (_airpods != null) {
            return _airpods!!
        }
        _airpods = Builder(name = "Airpods", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(5.7799f, 6.72f)
                curveTo(5.2599f, 6.72f, 4.8398f, 6.3001f, 4.8398f, 5.7801f)
                curveTo(4.8398f, 5.2601f, 5.2599f, 4.8401f, 5.7799f, 4.8401f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(17.28f, 13.52f)
                verticalLineTo(9.56f)
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(18.2207f, 6.72f)
                curveTo(18.7407f, 6.72f, 19.1607f, 6.3001f, 19.1607f, 5.7801f)
                curveTo(19.1607f, 5.2601f, 18.7407f, 4.8401f, 18.2207f, 4.8401f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
