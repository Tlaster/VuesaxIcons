...
public val TwotoneGroup.Like1: ImageVector
    get() {
        if (_like1 != null) {
            return _like1!!
        }
        _like1 = Builder(name = "Like1", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                moveTo(2.3809f, 18.3499f)
                verticalLineTo(8.5499f)
                curveTo(2.3809f, 7.1499f, 2.9809f, 6.6499f, 4.3809f, 6.6499f)
                horizontalLineTo(5.3809f)
                curveTo(6.7809f, 6.6499f, 7.3809f, 7.1499f, 7.3809f, 8.5499f)
                verticalLineTo(18.3499f)
                curveTo(7.3809f, 19.7499f, 6.7809f, 20.2499f, 5.3809f, 20.2499f)
                horizontalLineTo(4.3809f)
                curveTo(2.9809f, 20.2499f, 2.3809f, 19.7499f, 2.3809f, 18.3499f)
                close()
            }
        }
        .build()
