...
public val BoldGroup.Cloudchange: ImageVector
    get() {
        ...
        _cloudchange = Builder(name = "Cloudchange", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(8.1093f, 11.8498f)
                curveTo(5.2893f, 12.0498f, 5.2993f, 16.1498f, 8.1093f, 16.3498f)
                horizontalLineTo(14.7793f)
                curveTo(15.5893f, 16.3598f, 16.3693f, 16.0498f, 16.9693f, 15.5098f)
                curveTo(18.9493f, 13.7798f, 17.8893f, 10.3098f, 15.2893f, 9.9798f)
                curveTo(14.3593f, 4.3398f, 6.2093f, 6.4798f, 8.1393f, 11.8498f)
            }
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                ...
                curveTo(9.52f, 22.6f, 9.27f, 22.75f, 9.0f, 22.75f)
                close()
            }
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                ...
                curveTo(16.0804f, 4.6f, 15.6104f, 4.49f, 15.4004f, 4.13f)
