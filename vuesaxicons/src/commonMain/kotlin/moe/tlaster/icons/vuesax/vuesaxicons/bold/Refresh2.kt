...
public val BoldGroup.Refresh2: ImageVector
    get() {
        if (_refresh2 != null) {
            return _refresh2!!
        }
        _refresh2 = Builder(name = "Refresh2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(10.0f, 13.69f, 10.34f, 14.03f, 10.34f, 14.44f)
                curveTo(10.34f, 14.85f, 10.0f, 15.19f, 9.59f, 15.19f)
                horizontalLineTo(8.69f)
                curveTo(9.43f, 15.93f, 10.58f, 16.75f, 12.0f, 16.75f)
                curveTo(14.62f, 16.75f, 16.75f, 14.62f, 16.75f, 12.0f)
                curveTo(16.75f, 11.59f, 17.09f, 11.25f, 17.5f, 11.25f)
                curveTo(17.91f, 11.25f, 18.25f, 11.59f, 18.25f, 12.0f)
                curveTo(18.25f, 15.45f, 15.45f, 18.25f, 12.0f, 18.25f)
                close()
                moveTo(18.25f, 9.54f)
                ...
                curveTo(9.4f, 7.25f, 7.27f, 9.38f, 7.27f, 12.0f)
                curveTo(7.27f, 12.41f, 6.93f, 12.75f, 6.52f, 12.75f)
                curveTo(6.11f, 12.75f, 5.75f, 12.41f, 5.75f, 12.0f)
                curveTo(5.75f, 8.55f, 8.55f, 5.75f, 12.0f, 5.75f)
