    ...
    get() {
        ...
        _forward = Builder(name = "Forward", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                moveTo(11.7598f, 8.3399f)
                verticalLineTo(15.6599f)
                curveTo(11.7598f, 17.1599f, 13.3898f, 18.0999f, 14.6898f, 17.3499f)
                lineTo(17.8597f, 15.5299f)
                lineTo(21.0298f, 13.7f)
                curveTo(22.3298f, 12.95f, 22.3298f, 11.08f, 21.0298f, 10.32f)
                lineTo(17.8597f, 8.4899f)
                lineTo(14.6898f, 6.67f)
                curveTo(13.3898f, 5.9f, 11.7598f, 6.8399f, 11.7598f, 8.3399f)
                close()
            }
        }
        .build()
