...
public val BrokenGroup.Cloudconnection: ImageVector
    get() {
        ...
        _cloudconnection = Builder(name = "Cloudconnection", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                moveTo(6.41f, 9.5099f)
                curveTo(3.62f, 1.7499f, 15.41f, -1.3401f, 16.76f, 6.7999f)
                curveTo(20.18f, 7.2299f, 21.76f, 11.3899f, 19.88f, 14.0199f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(6.3707f, 9.51f)
                curveTo(2.2907f, 9.8f, 2.3007f, 15.71f, 6.3707f, 16.0f)
                horizontalLineTo(16.0307f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
