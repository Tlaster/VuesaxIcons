...
public val TwotoneGroup.Save2: ImageVector
    get() {
        if (_save2 != null) {
            return _save2!!
        }
        _save2 = Builder(name = "Save2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                moveTo(12.89f, 5.8799f)
                horizontalLineTo(5.11f)
                curveTo(3.4f, 5.8799f, 2.0f, 7.2799f, 2.0f, 8.9899f)
                verticalLineTo(20.3499f)
                curveTo(2.0f, 21.7999f, 3.04f, 22.4199f, 4.31f, 21.7099f)
                lineTo(8.24f, 19.5199f)
                curveTo(8.66f, 19.2899f, 9.34f, 19.2899f, 9.75f, 19.5199f)
                lineTo(13.68f, 21.7099f)
                curveTo(14.95f, 22.4199f, 15.99f, 21.7999f, 15.99f, 20.3499f)
