...
public val BoldGroup.Sidebarright: ImageVector
    get() {
        ...
        _sidebarright = Builder(name = "Sidebarright", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(20.2893f, 20.6612f, 20.6593f, 20.2913f, 20.9493f, 19.8713f)
                curveTo(21.6393f, 18.9212f, 21.9993f, 17.6813f, 21.9993f, 16.1913f)
