...
public val BulkGroup.Sort: ImageVector
    get() {
        if (_sort != null) {
            return _sort!!
        }
        _sort = Builder(name = "Sort", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(13.3302f, 17.0f)
                horizontalLineTo(10.6602f)
                curveTo(10.2502f, 17.0f, 9.9102f, 16.66f, 9.9102f, 16.25f)
                curveTo(9.9102f, 15.84f, 10.2502f, 15.5f, 10.6602f, 15.5f)
                horizontalLineTo(13.3302f)
                curveTo(13.7402f, 15.5f, 14.0802f, 15.84f, 14.0802f, 16.25f)
                curveTo(14.0802f, 16.66f, 13.7502f, 17.0f, 13.3302f, 17.0f)
                close()
            }
        }
        .build()
