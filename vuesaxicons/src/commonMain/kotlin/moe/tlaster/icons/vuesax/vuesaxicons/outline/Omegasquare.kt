...
public val OutlineGroup.Omegasquare: ImageVector
    get() {
        if (_omegasquare != null) {
            return _omegasquare!!
        }
        _omegasquare = Builder(name = "Omegasquare", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(9.16f, 7.04f, 10.54f, 6.5f, 12.0f, 6.5f)
