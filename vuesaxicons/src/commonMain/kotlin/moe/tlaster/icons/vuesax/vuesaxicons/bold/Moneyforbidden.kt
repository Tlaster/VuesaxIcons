...
public val BoldGroup.Moneyforbidden: ImageVector
    get() {
        if (_moneyforbidden != null) {
            return _moneyforbidden!!
        }
        _moneyforbidden = Builder(name = "Moneyforbidden", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(6.61f, 14.26f, 5.84f, 14.0f, 5.0f, 14.0f)
