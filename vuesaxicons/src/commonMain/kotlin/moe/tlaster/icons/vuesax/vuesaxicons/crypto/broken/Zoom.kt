...
public val BrokenGroup.Zoom: ImageVector
    get() {
        if (_zoom != null) {
            return _zoom!!
        }
        _zoom = Builder(name = "Zoom", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveTo(6.0f, 14.02f, 7.25f, 15.26f, 8.79f, 15.25f)
                lineTo(12.47f, 15.22f)
                curveTo(12.98f, 15.22f, 13.39f, 14.8f, 13.39f, 14.3f)
                verticalLineTo(11.53f)
                curveTo(13.39f, 10.0f, 12.15f, 8.76f, 10.62f, 8.76f)
                horizontalLineTo(6.93f)
                curveTo(6.41f, 8.76f, 6.0f, 9.17f, 6.0f, 9.68f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = EvenOdd) {
                moveTo(18.0005f, 9.24f)
                verticalLineTo(14.78f)
                lineTo(15.2305f, 12.93f)
                verticalLineTo(11.09f)
                lineTo(18.0005f, 9.24f)
                close()
            }
