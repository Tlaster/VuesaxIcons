...
public val TwotoneGroup.Moneychange: ImageVector
    get() {
        ...
        _moneychange = Builder(name = "Moneychange", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(3.22f, 14.2803f)
                lineTo(2.0f, 15.5002f)
                lineTo(3.22f, 16.7202f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(8.5f, 20.7803f)
                horizontalLineTo(3.16f)
                curveTo(2.52f, 20.7803f, 2.0f, 20.2603f, 2.0f, 19.6203f)
                verticalLineTo(18.3403f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(7.2793f, 22.0001f)
                lineTo(8.4993f, 20.7801f)
                lineTo(7.2793f, 19.5601f)
            }
        }
        .build()
        return _moneychange!!
