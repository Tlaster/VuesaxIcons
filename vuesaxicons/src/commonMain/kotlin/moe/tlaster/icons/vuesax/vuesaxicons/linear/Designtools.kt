...
public val LinearGroup.Designtools: ImageVector
    get() {
        ...
        _designtools = Builder(name = "Designtools", defaultWidth = 24.0.dp, defaultHeight =
            ...
            group {
                ...
                path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    ...
                    moveTo(20.12f, 12.73f)
                    lineTo(20.86f, 13.46f)
                    curveTo(22.35f, 14.95f, 22.35f, 16.42f, 20.86f, 17.91f)
                    lineTo(17.9f, 20.87f)
                    curveTo(16.43f, 22.34f, 14.94f, 22.34f, 13.47f, 20.87f)
                }
                path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                        strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                        strokeLineMiter = 4.0f, pathFillType = NonZero) {
                    moveTo(3.11f, 10.5101f)
                    curveTo(1.64f, 9.0201f, 1.64f, 7.5501f, 3.11f, 6.0601f)
                    lineTo(6.07f, 3.1001f)
                    curveTo(7.54f, 1.6301f, 9.03f, 1.6301f, 10.5f, 3.1001f)
                    lineTo(11.24f, 3.8401f)
                }
                path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                        strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                        strokeLineMiter = 4.0f, pathFillType = NonZero) {
                    moveTo(11.25f, 3.8501f)
                    lineTo(7.55f, 7.5501f)
                }
                path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                        strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                        strokeLineMiter = 4.0f, pathFillType = NonZero) {
                    moveTo(20.12f, 12.73f)
                    lineTo(17.16f, 15.68f)
                }
            }
        }
        .build()
