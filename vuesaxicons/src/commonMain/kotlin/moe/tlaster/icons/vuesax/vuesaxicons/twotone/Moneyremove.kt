...
public val TwotoneGroup.Moneyremove: ImageVector
    get() {
        if (_moneyremove != null) {
            return _moneyremove!!
        }
        _moneyremove = Builder(name = "Moneyremove", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(6.069f, 19.0402f)
                lineTo(3.959f, 16.9302f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(6.0397f, 16.96f)
                lineTo(3.9297f, 19.0699f)
            }
        }
        .build()
        return _moneyremove!!
