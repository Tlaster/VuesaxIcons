...
public val TwotoneGroup.Cloudconnection: ImageVector
    get() {
        ...
        _cloudconnection = Builder(name = "Cloudconnection", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                moveTo(6.3697f, 9.5102f)
                curveTo(2.2897f, 9.8002f, 2.2997f, 15.7102f, 6.3697f, 16.0002f)
                horizontalLineTo(16.0297f)
                curveTo(17.1997f, 16.0102f, 18.3297f, 15.5702f, 19.1997f, 14.7802f)
                curveTo(22.0597f, 12.2802f, 20.5297f, 7.2801f, 16.7597f, 6.8001f)
                curveTo(15.4097f, -1.3398f, 3.6197f, 1.7502f, 6.4097f, 9.5102f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
