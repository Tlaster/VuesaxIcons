...
public val OutlineGroup.Maincomponent: ImageVector
    get() {
        ...
        _maincomponent = Builder(name = "Maincomponent", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(17.7495f, 18.5f)
                curveTo(17.5595f, 18.5f, 17.3695f, 18.43f, 17.2195f, 18.28f)
                lineTo(5.7194f, 6.78f)
                curveTo(5.4295f, 6.49f, 5.4295f, 6.0099f, 5.7194f, 5.7199f)
                curveTo(6.0094f, 5.4299f, 6.4894f, 5.4299f, 6.7794f, 5.7199f)
                lineTo(18.2795f, 17.2199f)
                curveTo(18.5695f, 17.5099f, 18.5695f, 17.99f, 18.2795f, 18.28f)
                curveTo(18.1295f, 18.43f, 17.9395f, 18.5f, 17.7495f, 18.5f)
                close()
            }
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(6.2495f, 18.5f)
                curveTo(6.0595f, 18.5f, 5.8695f, 18.43f, 5.7194f, 18.28f)
                curveTo(5.4295f, 17.99f, 5.4295f, 17.5099f, 5.7194f, 17.2199f)
                lineTo(17.2195f, 5.7199f)
                curveTo(17.5095f, 5.4299f, 17.9895f, 5.4299f, 18.2795f, 5.7199f)
                curveTo(18.5695f, 6.0099f, 18.5695f, 6.49f, 18.2795f, 6.78f)
                lineTo(6.7794f, 18.28f)
                curveTo(6.6294f, 18.43f, 6.4394f, 18.5f, 6.2495f, 18.5f)
                close()
            }
        }
        .build()
