...
public val BrokenGroup.Toggleon: ImageVector
    get() {
        if (_toggleon != null) {
            return _toggleon!!
        }
        _toggleon = Builder(name = "Toggleon", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                curveTo(18.5f, 15.2f, 17.7f, 16.0f, 15.7f, 16.0f)
                horizontalLineTo(13.3f)
                curveTo(11.3f, 16.0f, 10.5f, 15.2f, 10.5f, 13.2f)
                verticalLineTo(10.8f)
                curveTo(10.5f, 8.8f, 11.3f, 8.0f, 13.3f, 8.0f)
