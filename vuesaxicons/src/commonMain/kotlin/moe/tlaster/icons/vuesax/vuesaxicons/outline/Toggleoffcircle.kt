...
public val OutlineGroup.Toggleoffcircle: ImageVector
    get() {
        ...
        _toggleoffcircle = Builder(name = "Toggleoffcircle", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(10.0f, 16.75f)
                curveTo(7.38f, 16.75f, 5.25f, 14.62f, 5.25f, 12.0f)
                curveTo(5.25f, 9.38f, 7.38f, 7.25f, 10.0f, 7.25f)
                curveTo(12.62f, 7.25f, 14.75f, 9.38f, 14.75f, 12.0f)
                curveTo(14.75f, 14.62f, 12.62f, 16.75f, 10.0f, 16.75f)
                close()
                moveTo(10.0f, 8.75f)
                curveTo(8.21f, 8.75f, 6.75f, 10.21f, 6.75f, 12.0f)
                curveTo(6.75f, 13.79f, 8.21f, 15.25f, 10.0f, 15.25f)
                curveTo(11.79f, 15.25f, 13.25f, 13.79f, 13.25f, 12.0f)
                curveTo(13.25f, 10.21f, 11.79f, 8.75f, 10.0f, 8.75f)
                close()
            }
        }
        .build()
