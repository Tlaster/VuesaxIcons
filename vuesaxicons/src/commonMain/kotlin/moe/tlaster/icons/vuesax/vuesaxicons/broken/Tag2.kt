...
public val BrokenGroup.Tag2: ImageVector
    get() {
        if (_tag2 != null) {
            return _tag2!!
        }
        _tag2 = Builder(name = "Tag2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                lineTo(19.8305f, 15.43f)
                curveTo(21.6905f, 13.57f, 21.6905f, 10.55f, 19.8305f, 8.68f)
                lineTo(18.7005f, 7.55f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(8.51f, 11.8f)
                curveTo(8.81f, 11.93f, 9.15f, 12.0f, 9.5f, 12.0f)
