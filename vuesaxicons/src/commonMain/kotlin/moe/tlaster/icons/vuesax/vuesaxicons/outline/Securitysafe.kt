...
public val OutlineGroup.Securitysafe: ImageVector
    get() {
        ...
        _securitysafe = Builder(name = "Securitysafe", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(9.25f, 8.98f, 10.48f, 7.75f, 12.0f, 7.75f)
                curveTo(13.52f, 7.75f, 14.75f, 8.98f, 14.75f, 10.5f)
                curveTo(14.75f, 12.02f, 13.52f, 13.25f, 12.0f, 13.25f)
                close()
                moveTo(12.0f, 9.25f)
                curveTo(11.31f, 9.25f, 10.75f, 9.81f, 10.75f, 10.5f)
                curveTo(10.75f, 11.19f, 11.31f, 11.75f, 12.0f, 11.75f)
                curveTo(12.69f, 11.75f, 13.25f, 11.19f, 13.25f, 10.5f)
                curveTo(13.25f, 9.81f, 12.69f, 9.25f, 12.0f, 9.25f)
                close()
            }
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                ...
                curveTo(11.25f, 12.09f, 11.59f, 11.75f, 12.0f, 11.75f)
