...
public val LinearGroup.Zoom: ImageVector
    get() {
        if (_zoom != null) {
            return _zoom!!
        }
        _zoom = Builder(name = "Zoom", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF17191C)),
                ...
                curveTo(6.0f, 14.0f, 7.3f, 15.3f, 8.8f, 15.3f)
                horizontalLineTo(12.5f)
                curveTo(13.0f, 15.3f, 13.4f, 14.9f, 13.4f, 14.4f)
                verticalLineTo(11.6f)
                curveTo(13.4f, 10.1f, 12.2f, 8.8f, 10.6f, 8.8f)
                horizontalLineTo(6.9f)
                curveTo(6.4f, 8.8f, 6.0f, 9.2001f, 6.0f, 9.7001f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF17191C)),
