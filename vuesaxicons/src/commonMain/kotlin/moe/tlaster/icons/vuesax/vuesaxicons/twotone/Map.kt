    ...
    get() {
        ...
        _map = Builder(name = "Map", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp, viewportWidth
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                moveTo(6.2393f, 7.9802f)
                curveTo(6.9193f, 5.0502f, 11.3193f, 5.0502f, 11.9993f, 7.9802f)
                curveTo(12.3893f, 9.7002f, 11.3093f, 11.1602f, 10.3593f, 12.0602f)
                curveTo(9.6693f, 12.7202f, 8.5793f, 12.7202f, 7.8793f, 12.0602f)
                curveTo(6.9293f, 11.1602f, 5.8393f, 9.7002f, 6.2393f, 7.9802f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
