...
public val BrokenGroup.Hearttick: ImageVector
    get() {
        if (_hearttick != null) {
            return _hearttick!!
        }
        _hearttick = Builder(name = "Hearttick", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(22.0004f, 17.2f)
                curveTo(22.0004f, 18.1f, 21.7504f, 18.95f, 21.3004f, 19.67f)
                curveTo(20.4704f, 21.06f, 18.9504f, 22.0f, 17.2004f, 22.0f)
                curveTo(15.4504f, 22.0f, 13.9204f, 21.06f, 13.1004f, 19.67f)
                curveTo(12.6604f, 18.95f, 12.4004f, 18.1f, 12.4004f, 17.2f)
                curveTo(12.4004f, 14.55f, 14.5504f, 12.4f, 17.2004f, 12.4f)
                curveTo(19.8504f, 12.4f, 22.0004f, 14.55f, 22.0004f, 17.2f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
