...
public val BrokenGroup.Searchfavorite: ImageVector
    get() {
        ...
        _searchfavorite = Builder(name = "Searchfavorite", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(21.0007f, 11.5f)
                curveTo(21.0007f, 16.75f, 16.7507f, 21.0f, 11.5007f, 21.0f)
                curveTo(7.7607f, 21.0f, 4.5207f, 18.84f, 2.9707f, 15.69f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
