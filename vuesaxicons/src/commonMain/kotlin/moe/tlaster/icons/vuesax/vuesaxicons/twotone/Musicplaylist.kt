...
public val TwotoneGroup.Musicplaylist: ImageVector
    get() {
        ...
        _musicplaylist = Builder(name = "Musicplaylist", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                moveTo(8.8895f, 19.1101f)
                curveTo(9.6462f, 19.1101f, 10.2595f, 18.4967f, 10.2595f, 17.7401f)
                curveTo(10.2595f, 16.9835f, 9.6462f, 16.3701f, 8.8895f, 16.3701f)
                curveTo(8.1329f, 16.3701f, 7.5195f, 16.9835f, 7.5195f, 17.7401f)
                curveTo(7.5195f, 18.4967f, 8.1329f, 19.1101f, 8.8895f, 19.1101f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    fillAlpha = 0.4f, strokeAlpha = 0.4f, strokeLineWidth = 1.5f, strokeLineCap =
