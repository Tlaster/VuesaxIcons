...
public val LinearGroup.User: ImageVector
    get() {
        if (_user != null) {
            return _user!!
        }
        _user = Builder(name = "User", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(20.5899f, 22.0f)
                curveTo(20.5899f, 18.13f, 16.7399f, 15.0f, 11.9999f, 15.0f)
                curveTo(7.2599f, 15.0f, 3.4099f, 18.13f, 3.4099f, 22.0f)
            }
        }
        .build()
        return _user!!
