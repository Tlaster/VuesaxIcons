...
public val BrokenGroup.Gemini: ImageVector
    get() {
        if (_gemini != null) {
            return _gemini!!
        }
        _gemini = Builder(name = "Gemini", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(6.8698f, 7.51f)
                curveTo(7.9998f, 11.81f, 7.4898f, 16.42f, 5.3398f, 20.4f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(18.6694f, 20.41f)
                curveTo(15.8894f, 15.25f, 15.8394f, 9.0301f, 18.5694f, 3.8201f)
                lineTo(18.6994f, 3.5801f)
            }
        }
        .build()
        return _gemini!!
