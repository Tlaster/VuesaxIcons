...
public val TwotoneGroup.Printerslash: ImageVector
    get() {
        if (_printerslash != null) {
            return _printerslash!!
        }
        _printerslash = Builder(name = "Printerslash", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                moveTo(12.9703f, 15.0f)
                horizontalLineTo(16.0003f)
                verticalLineTo(19.0f)
                curveTo(16.0003f, 21.0f, 15.0003f, 22.0f, 13.0003f, 22.0f)
                horizontalLineTo(11.0003f)
                curveTo(9.3103f, 22.0f, 8.3303f, 21.29f, 8.0703f, 19.86f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
