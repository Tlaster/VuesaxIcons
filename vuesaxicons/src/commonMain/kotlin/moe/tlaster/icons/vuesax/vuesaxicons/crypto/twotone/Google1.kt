...
public val TwotoneGroup.Google1: ImageVector
    get() {
        if (_google1 != null) {
            return _google1!!
        }
        _google1 = Builder(name = "Google1", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(15.1799f, 3.0f)
                horizontalLineTo(8.83f)
                lineTo(1.4199f, 15.71f)
                lineTo(4.5999f, 21.0f)
                horizontalLineTo(19.4199f)
                curveTo(19.4199f, 21.0f, 22.5999f, 15.55f, 22.5999f, 15.63f)
                curveTo(22.5999f, 15.71f, 15.1799f, 3.0f, 15.1799f, 3.0f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
