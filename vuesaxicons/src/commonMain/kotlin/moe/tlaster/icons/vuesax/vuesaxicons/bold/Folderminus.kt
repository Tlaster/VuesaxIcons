    ...
    get() {
        ...
        _folderminus = Builder(name = "Folderminus", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(21.9815f, 11.1957f, 21.5343f, 10.75f, 20.9833f, 10.75f)
                lineTo(3.0f, 10.7507f)
                curveTo(2.4477f, 10.7507f, 2.0f, 11.1984f, 2.0f, 11.7507f)
                verticalLineTo(16.6507f)
                curveTo(2.0f, 19.6007f, 4.4f, 22.0007f, 7.35f, 22.0007f)
                horizontalLineTo(16.65f)
                curveTo(19.6f, 22.0007f, 22.0f, 19.6007f, 22.0f, 16.6507f)
                lineTo(21.9834f, 11.7466f)
                close()
                moveTo(14.43f, 16.7507f)
                horizontalLineTo(9.43f)
                curveTo(9.01f, 16.7507f, 8.68f, 16.4207f, 8.68f, 16.0007f)
                curveTo(8.68f, 15.5907f, 9.01f, 15.2507f, 9.43f, 15.2507f)
                horizontalLineTo(14.43f)
                curveTo(14.84f, 15.2507f, 15.18f, 15.5907f, 15.18f, 16.0007f)
                curveTo(15.18f, 16.4207f, 14.84f, 16.7507f, 14.43f, 16.7507f)
                close()
            }
        }
        .build()
