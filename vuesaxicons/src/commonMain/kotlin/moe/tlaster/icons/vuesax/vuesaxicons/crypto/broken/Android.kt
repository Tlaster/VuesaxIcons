...
public val BrokenGroup.Android: ImageVector
    get() {
        if (_android != null) {
            return _android!!
        }
        _android = Builder(name = "Android", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveTo(11.0f, 21.55f, 10.55f, 22.0f, 10.0f, 22.0f)
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveTo(3.0f, 10.45f, 3.45f, 10.0f, 4.0f, 10.0f)
                curveTo(4.55f, 10.0f, 5.0f, 10.45f, 5.0f, 11.0f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                ...
                moveTo(21.0f, 11.0f)
                verticalLineTo(15.0f)
                curveTo(21.0f, 15.55f, 20.55f, 16.0f, 20.0f, 16.0f)
                curveTo(19.45f, 16.0f, 19.0f, 15.55f, 19.0f, 15.0f)
                verticalLineTo(11.0f)
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                curveTo(15.28f, 6.9999f, 16.0f, 6.2799f, 16.0f, 5.3999f)
                curveTo(16.0f, 3.1899f, 14.21f, 1.3999f, 12.0f, 1.3999f)
                curveTo(9.79f, 1.3999f, 8.0f, 3.1899f, 8.0f, 5.3999f)
                curveTo(8.0f, 6.2799f, 8.72f, 6.9999f, 9.6f, 6.9999f)
                close()
            }
        }
        .build()
