...
public val BrokenGroup.Refreshcircle: ImageVector
    get() {
        ...
        _refreshcircle = Builder(name = "Refreshcircle", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(7.3398f, 11.3301f)
                curveTo(7.4798f, 10.3501f, 7.9099f, 9.41f, 8.6599f, 8.66f)
                curveTo(10.4999f, 6.82f, 13.4898f, 6.82f, 15.3398f, 8.66f)
                curveTo(15.5998f, 8.92f, 15.8098f, 9.2001f, 15.9898f, 9.4901f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(7.8203f, 17.18f)
