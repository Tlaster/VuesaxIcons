...
public val BulkGroup.Hierarchy3: ImageVector
    get() {
        if (_hierarchy3 != null) {
            return _hierarchy3!!
        }
        _hierarchy3 = Builder(name = "Hierarchy3", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, fillAlpha = 0.4f, strokeAlpha
                ...
                verticalLineTo(8.0f)
                curveTo(4.25f, 7.59f, 4.59f, 7.25f, 5.0f, 7.25f)
                curveTo(5.41f, 7.25f, 5.75f, 7.59f, 5.75f, 8.0f)
                curveTo(5.75f, 10.19f, 6.81f, 11.25f, 9.0f, 11.25f)
                ...
                curveTo(5.75f, 16.41f, 5.41f, 16.75f, 5.0f, 16.75f)
                close()
            }
        }
        .build()
