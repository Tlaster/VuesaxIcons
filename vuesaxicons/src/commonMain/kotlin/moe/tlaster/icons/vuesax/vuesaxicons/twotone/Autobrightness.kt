...
public val TwotoneGroup.Autobrightness: ImageVector
    get() {
        ...
        _autobrightness = Builder(name = "Autobrightness", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    ...
                    Butt, strokeLineJoin = Bevel, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(8.5f, 15.9396f)
                lineTo(12.0f, 8.0596f)
                lineTo(15.5f, 15.9396f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    fillAlpha = 0.4f, strokeAlpha = 0.4f, strokeLineWidth = 1.5f, strokeLineCap =
                    Round, strokeLineJoin = StrokeJoin.Companion.Round, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(13.75f, 13.3096f)
