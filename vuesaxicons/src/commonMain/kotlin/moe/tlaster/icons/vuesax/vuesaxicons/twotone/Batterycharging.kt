...
public val TwotoneGroup.Batterycharging: ImageVector
    get() {
        ...
        _batterycharging = Builder(name = "Batterycharging", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    ...
                    pathFillType = NonZero) {
                moveTo(9.9992f, 8.0f)
                lineTo(8.1092f, 10.5f)
                curveTo(7.7192f, 11.17f, 8.1992f, 12.0f, 8.9692f, 12.0f)
                horizontalLineTo(11.2692f)
                curveTo(12.0392f, 12.0f, 12.5192f, 12.83f, 12.1392f, 13.5f)
                lineTo(9.9992f, 16.0f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
