...
public val BrokenGroup.Boxsearch: ImageVector
    get() {
        if (_boxsearch != null) {
            return _boxsearch!!
        }
        _boxsearch = Builder(name = "Boxsearch", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(14.0706f, 21.5201f)
                curveTo(13.5006f, 21.8401f, 12.7506f, 22.0001f, 12.0006f, 22.0001f)
                curveTo(11.2506f, 22.0001f, 10.5006f, 21.8401f, 9.9306f, 21.5201f)
                lineTo(4.5906f, 18.5601f)
                curveTo(3.3806f, 17.8901f, 2.3906f, 16.2101f, 2.3906f, 14.8301f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
