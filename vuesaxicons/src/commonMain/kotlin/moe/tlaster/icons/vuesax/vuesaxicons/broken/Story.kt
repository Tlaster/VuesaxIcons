...
public val BrokenGroup.Story: ImageVector
    get() {
        if (_story != null) {
            return _story!!
        }
        _story = Builder(name = "Story", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                moveTo(16.42f, 7.95f)
                curveTo(18.86f, 10.39f, 18.86f, 14.3499f, 16.42f, 16.7899f)
                curveTo(13.98f, 19.2299f, 10.02f, 19.2299f, 7.58f, 16.7899f)
                curveTo(5.14f, 14.3499f, 5.14f, 10.39f, 7.58f, 7.95f)
                curveTo(8.95f, 6.58f, 10.81f, 5.98f, 12.6f, 6.15f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
