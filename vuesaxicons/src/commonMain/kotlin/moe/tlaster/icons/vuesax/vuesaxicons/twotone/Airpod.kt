...
public val TwotoneGroup.Airpod: ImageVector
    get() {
        if (_airpod != null) {
            return _airpod!!
        }
        _airpod = Builder(name = "Airpod", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    ...
                    Round, strokeLineJoin = StrokeJoin.Companion.Round, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(17.1301f, 8.9201f)
                curveTo(17.1301f, 10.0501f, 16.2101f, 10.9701f, 15.0801f, 10.9701f)
                horizontalLineTo(8.9201f)
                curveTo(8.3601f, 10.9701f, 7.8401f, 10.7401f, 7.4701f, 10.3601f)
                curveTo(7.1001f, 10.0001f, 6.8701f, 9.4901f, 6.8701f, 8.9201f)
                curveTo(6.8701f, 7.7901f, 7.7901f, 6.8701f, 8.9201f, 6.8701f)
                horizontalLineTo(15.0701f)
                curveTo(15.6301f, 6.8701f, 16.1501f, 7.1001f, 16.5201f, 7.4801f)
                curveTo(16.9001f, 7.8501f, 17.1301f, 8.3601f, 17.1301f, 8.9201f)
                close()
            }
        }
        .build()
