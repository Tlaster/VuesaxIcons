...
public val TwotoneGroup.Emojihappy: ImageVector
    get() {
        if (_emojihappy != null) {
            return _emojihappy!!
        }
        _emojihappy = Builder(name = "Emojihappy", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    ...
                    Round, strokeLineJoin = StrokeJoin.Companion.Round, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(8.4f, 13.2998f)
                horizontalLineTo(15.6f)
                curveTo(16.1f, 13.2998f, 16.5f, 13.6998f, 16.5f, 14.1998f)
                curveTo(16.5f, 16.6898f, 14.49f, 18.6998f, 12.0f, 18.6998f)
                curveTo(9.51f, 18.6998f, 7.5f, 16.6898f, 7.5f, 14.1998f)
                curveTo(7.5f, 13.6998f, 7.9f, 13.2998f, 8.4f, 13.2998f)
                close()
            }
        }
        .build()
