...
public val OutlineGroup.Radar2: ImageVector
    get() {
        if (_radar2 != null) {
            return _radar2!!
        }
        _radar2 = Builder(name = "Radar2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(12.0f, 18.75f)
                curveTo(8.28f, 18.75f, 5.25f, 15.72f, 5.25f, 12.0f)
                ...
                curveTo(7.01f, 10.14f, 6.76f, 11.06f, 6.76f, 12.0f)
                curveTo(6.76f, 14.9f, 9.12f, 17.25f, 12.01f, 17.25f)
                curveTo(14.9f, 17.25f, 17.26f, 14.9f, 17.26f, 12.0f)
                ...
                curveTo(10.03f, 5.47f, 11.0f, 5.25f, 12.0f, 5.25f)
                curveTo(15.72f, 5.25f, 18.75f, 8.28f, 18.75f, 12.0f)
                curveTo(18.75f, 15.72f, 15.72f, 18.75f, 12.0f, 18.75f)
                close()
            }
        }
        .build()
