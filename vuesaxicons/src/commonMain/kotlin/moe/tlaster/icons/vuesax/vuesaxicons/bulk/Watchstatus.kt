...
public val BulkGroup.Watchstatus: ImageVector
    get() {
        if (_watchstatus != null) {
            return _watchstatus!!
        }
        _watchstatus = Builder(name = "Watchstatus", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(12.75f, 14.42f, 12.41f, 14.75f, 12.0f, 14.75f)
                close()
            }
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                ...
                verticalLineTo(14.0f)
                curveTo(15.75f, 14.42f, 15.42f, 14.75f, 15.0f, 14.75f)
                close()
            }
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
