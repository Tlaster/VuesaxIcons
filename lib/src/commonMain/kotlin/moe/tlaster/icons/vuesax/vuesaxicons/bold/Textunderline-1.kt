...
public val BoldGroup.`Textunderline-1`: ImageVector
    get() {
        if (`_textunderline-1` != null) {
            return `_textunderline-1`!!
        }
        `_textunderline-1` = Builder(name = "Textunderline-1", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(17.58f, 13.7f, 15.08f, 16.2f, 12.0f, 16.2f)
                ...
                curveTo(7.92f, 12.87f, 9.75f, 14.7f, 12.0f, 14.7f)
...
private var `_textunderline-1`: ImageVector? = null
