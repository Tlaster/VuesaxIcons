...
public val LinearGroup.`Volume-high`: ImageVector
    get() {
        if (`_volume-high` != null) {
            return `_volume-high`!!
        }
        `_volume-high` = Builder(name = "Volume-high", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_volume-high`: ImageVector? = null
