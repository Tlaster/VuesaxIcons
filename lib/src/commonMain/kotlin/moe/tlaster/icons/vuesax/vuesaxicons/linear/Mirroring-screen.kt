...
public val LinearGroup.`Mirroring-screen`: ImageVector
    get() {
        if (`_mirroring-screen` != null) {
            return `_mirroring-screen`!!
        }
        `_mirroring-screen` = Builder(name = "Mirroring-screen", defaultWidth = 24.0.dp,
...
private var `_mirroring-screen`: ImageVector? = null
