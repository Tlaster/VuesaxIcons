...
public val LinearGroup.`Directbox-default`: ImageVector
    get() {
        if (`_directbox-default` != null) {
            return `_directbox-default`!!
        }
        `_directbox-default` = Builder(name = "Directbox-default", defaultWidth = 24.0.dp,
...
private var `_directbox-default`: ImageVector? = null
