...
public val BoldGroup.`Folder-favorite`: ImageVector
    get() {
        if (`_folder-favorite` != null) {
            return `_folder-favorite`!!
        }
        `_folder-favorite` = Builder(name = "Folder-favorite", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(3.0f, 10.75f)
                curveTo(2.4477f, 10.75f, 2.0f, 11.1977f, 2.0f, 11.75f)
                verticalLineTo(16.65f)
                curveTo(2.0f, 19.6f, 4.4f, 22.0f, 7.35f, 22.0f)
                horizontalLineTo(16.65f)
                curveTo(19.6f, 22.0f, 22.0f, 19.6f, 22.0f, 16.65f)
                lineTo(21.9834f, 11.7466f)
                close()
                moveTo(14.54f, 16.97f)
                lineTo(12.39f, 18.85f)
                curveTo(12.28f, 18.95f, 12.14f, 19.0f, 12.0f, 19.0f)
                curveTo(11.86f, 19.0f, 11.72f, 18.95f, 11.61f, 18.85f)
                lineTo(9.46f, 16.97f)
...
private var `_folder-favorite`: ImageVector? = null
