...
public val LinearGroup.`Bucket-circle-1`: ImageVector
    get() {
        if (`_bucket-circle-1` != null) {
            return `_bucket-circle-1`!!
        }
        `_bucket-circle-1` = Builder(name = "Bucket-circle-1", defaultWidth = 24.0.dp, defaultHeight
...
private var `_bucket-circle-1`: ImageVector? = null
