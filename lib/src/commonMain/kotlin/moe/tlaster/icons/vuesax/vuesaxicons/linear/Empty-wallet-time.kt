...
public val LinearGroup.`Empty-wallet-time`: ImageVector
    get() {
        ...
        `_empty-wallet-time` = Builder(name = "Empty-wallet-time", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    ...
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(9.0f, 19.0f)
                curveTo(9.0f, 20.2f, 8.47f, 21.27f, 7.64f, 22.0f)
                curveTo(6.93f, 22.62f, 6.01f, 23.0f, 5.0f, 23.0f)
                curveTo(2.79f, 23.0f, 1.0f, 21.21f, 1.0f, 19.0f)
