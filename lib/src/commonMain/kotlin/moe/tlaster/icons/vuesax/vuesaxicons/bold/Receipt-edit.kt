...
public val BoldGroup.`Receipt-edit`: ImageVector
    get() {
        if (`_receipt-edit` != null) {
            return `_receipt-edit`!!
        }
        `_receipt-edit` = Builder(name = "Receipt-edit", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_receipt-edit`: ImageVector? = null
