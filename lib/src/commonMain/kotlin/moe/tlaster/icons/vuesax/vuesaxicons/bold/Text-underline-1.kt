...
public val BoldGroup.`Text-underline-1`: ImageVector
    get() {
        if (`_text-underline-1` != null) {
            return `_text-underline-1`!!
        }
        `_text-underline-1` = Builder(name = "Text-underline-1", defaultWidth = 24.0.dp,
...
private var `_text-underline-1`: ImageVector? = null
