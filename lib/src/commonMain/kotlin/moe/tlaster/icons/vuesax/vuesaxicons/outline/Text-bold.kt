...
public val OutlineGroup.`Text-bold`: ImageVector
    get() {
        if (`_text-bold` != null) {
            return `_text-bold`!!
        }
        `_text-bold` = Builder(name = "Text-bold", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_text-bold`: ImageVector? = null
