...
public val BoldGroup.`Rotate-left-1`: ImageVector
    get() {
        if (`_rotate-left-1` != null) {
            return `_rotate-left-1`!!
        }
        `_rotate-left-1` = Builder(name = "Rotate-left-1", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 18.58f)
                curveTo(8.83f, 18.58f, 6.25f, 16.0f, 6.25f, 12.83f)
                ...
                curveTo(8.0f, 11.17f, 7.76f, 11.99f, 7.76f, 12.83f)
                ...
                curveTo(17.75f, 16.0f, 15.17f, 18.58f, 12.0f, 18.58f)
                close()
            }
        }
        .build()
...
private var `_rotate-left-1`: ImageVector? = null
