...
public val BoldGroup.`Textalignright-1`: ImageVector
    get() {
        if (`_textalignright-1` != null) {
            return `_textalignright-1`!!
        }
        `_textalignright-1` = Builder(name = "Textalignright-1", defaultWidth = 24.0.dp,
...
private var `_textalignright-1`: ImageVector? = null
