...
public val LinearGroup.`Clipboard-import`: ImageVector
    get() {
        if (`_clipboard-import` != null) {
            return `_clipboard-import`!!
        }
        `_clipboard-import` = Builder(name = "Clipboard-import", defaultWidth = 24.0.dp,
...
private var `_clipboard-import`: ImageVector? = null
