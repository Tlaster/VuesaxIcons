...
public val BoldGroup.`Message-text`: ImageVector
    get() {
        if (`_message-text` != null) {
            return `_message-text`!!
        }
        `_message-text` = Builder(name = "Message-text", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_message-text`: ImageVector? = null
