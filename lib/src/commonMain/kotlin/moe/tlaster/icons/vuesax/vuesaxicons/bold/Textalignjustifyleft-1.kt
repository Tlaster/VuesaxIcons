...
public val BoldGroup.`Textalignjustifyleft-1`: ImageVector
    get() {
        if (`_textalignjustifyleft-1` != null) {
            return `_textalignjustifyleft-1`!!
        }
        `_textalignjustifyleft-1` = Builder(name = "Textalignjustifyleft-1", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(12.75f, 4.91f, 12.41f, 5.25f, 12.0f, 5.25f)
                close()
            }
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
...
private var `_textalignjustifyleft-1`: ImageVector? = null
