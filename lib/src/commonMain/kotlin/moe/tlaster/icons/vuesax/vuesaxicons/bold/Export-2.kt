...
public val BoldGroup.`Export-2`: ImageVector
    get() {
        if (`_export-2` != null) {
            return `_export-2`!!
        }
        `_export-2` = Builder(name = "Export-2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_export-2`: ImageVector? = null
