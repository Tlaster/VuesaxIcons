...
public val LinearGroup.`Cloud-cross`: ImageVector
    get() {
        if (`_cloud-cross` != null) {
            return `_cloud-cross`!!
        }
        `_cloud-cross` = Builder(name = "Cloud-cross", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(12.3901f, 18.59f)
                lineTo(9.5601f, 21.41f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(12.3901f, 21.41f)
                lineTo(9.5601f, 18.59f)
            }
        }
        .build()
        return `_cloud-cross`!!
...
private var `_cloud-cross`: ImageVector? = null
