...
public val LinearGroup.`Notification-status`: ImageVector
    get() {
        if (`_notification-status` != null) {
            return `_notification-status`!!
        }
        `_notification-status` = Builder(name = "Notification-status", defaultWidth = 24.0.dp,
...
private var `_notification-status`: ImageVector? = null
