...
public val BoldGroup.`Textalignleft-1`: ImageVector
    get() {
        if (`_textalignleft-1` != null) {
            return `_textalignleft-1`!!
        }
        `_textalignleft-1` = Builder(name = "Textalignleft-1", defaultWidth = 24.0.dp, defaultHeight
...
private var `_textalignleft-1`: ImageVector? = null
