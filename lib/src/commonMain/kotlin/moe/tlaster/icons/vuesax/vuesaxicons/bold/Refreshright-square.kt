...
public val BoldGroup.`Refreshright-square`: ImageVector
    get() {
        if (`_refreshright-square` != null) {
            return `_refreshright-square`!!
        }
        `_refreshright-square` = Builder(name = "Refreshright-square", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(6.25f, 9.09f, 8.83f, 6.51f, 12.0f, 6.51f)
                ...
                curveTo(15.07f, 7.91f, 15.06f, 7.96f, 15.04f, 8.0f)
                ...
                curveTo(11.6f, 9.17f, 11.67f, 8.7f, 12.0f, 8.45f)
                lineTo(12.56f, 8.04f)
                curveTo(12.37f, 8.03f, 12.19f, 8.01f, 12.0f, 8.01f)
                curveTo(9.66f, 8.01f, 7.75f, 9.92f, 7.75f, 12.26f)
                curveTo(7.75f, 14.6f, 9.66f, 16.51f, 12.0f, 16.51f)
                curveTo(14.34f, 16.51f, 16.25f, 14.6f, 16.25f, 12.26f)
                curveTo(16.25f, 11.41f, 16.0f, 10.6f, 15.54f, 9.9f)
                ...
                curveTo(17.75f, 15.44f, 15.17f, 18.01f, 12.0f, 18.01f)
                close()
            }
        }
        .build()
...
private var `_refreshright-square`: ImageVector? = null
