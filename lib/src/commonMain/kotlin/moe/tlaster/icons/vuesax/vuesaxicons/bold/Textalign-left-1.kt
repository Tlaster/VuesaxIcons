...
public val BoldGroup.`Textalign-left-1`: ImageVector
    get() {
        if (`_textalign-left-1` != null) {
            return `_textalign-left-1`!!
        }
        `_textalign-left-1` = Builder(name = "Textalign-left-1", defaultWidth = 24.0.dp,
...
private var `_textalign-left-1`: ImageVector? = null
