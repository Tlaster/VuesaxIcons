...
public val BoldGroup.Moneychange: ImageVector
    get() {
        ...
        _moneychange = Builder(name = "Moneychange", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(5.0f, 14.0f)
                curveTo(3.75f, 14.0f, 2.62f, 14.59f, 1.89f, 15.49f)
                curveTo(1.33f, 16.18f, 1.0f, 17.05f, 1.0f, 18.0f)
                curveTo(1.0f, 20.21f, 2.8f, 22.0f, 5.0f, 22.0f)
                curveTo(6.74f, 22.0f, 8.23f, 20.89f, 8.77f, 19.33f)
                curveTo(8.92f, 18.92f, 9.0f, 18.47f, 9.0f, 18.0f)
                curveTo(9.0f, 15.8f, 7.21f, 14.0f, 5.0f, 14.0f)
                close()
                moveTo(7.36f, 19.74f)
