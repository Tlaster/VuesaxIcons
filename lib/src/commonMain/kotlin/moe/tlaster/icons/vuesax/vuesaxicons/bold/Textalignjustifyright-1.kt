...
public val BoldGroup.`Textalignjustifyright-1`: ImageVector
    get() {
        if (`_textalignjustifyright-1` != null) {
            return `_textalignjustifyright-1`!!
        }
        `_textalignjustifyright-1` = Builder(name = "Textalignjustifyright-1", defaultWidth =
...
private var `_textalignjustifyright-1`: ImageVector? = null
