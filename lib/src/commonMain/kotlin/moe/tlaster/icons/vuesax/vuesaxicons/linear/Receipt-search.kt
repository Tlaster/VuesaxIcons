...
public val LinearGroup.`Receipt-search`: ImageVector
    get() {
        if (`_receipt-search` != null) {
            return `_receipt-search`!!
        }
        `_receipt-search` = Builder(name = "Receipt-search", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_receipt-search`: ImageVector? = null
