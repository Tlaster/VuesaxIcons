...
public val BoldGroup.`Textbold-1`: ImageVector
    get() {
        if (`_textbold-1` != null) {
            return `_textbold-1`!!
        }
        `_textbold-1` = Builder(name = "Textbold-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_textbold-1`: ImageVector? = null
