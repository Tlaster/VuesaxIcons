...
public val BoldGroup.`Lamp-charge`: ImageVector
    get() {
        ...
        `_lamp-charge` = Builder(name = "Lamp-charge", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(13.7207f, 11.6215f)
                lineTo(12.6507f, 13.4815f)
                curveTo(12.5107f, 13.7215f, 12.2607f, 13.8615f, 12.0007f, 13.8615f)
                curveTo(11.8707f, 13.8615f, 11.7407f, 13.8315f, 11.6307f, 13.7615f)
                curveTo(11.2707f, 13.5515f, 11.1507f, 13.0915f, 11.3507f, 12.7415f)
                lineTo(12.2007f, 11.2615f)
                horizontalLineTo(11.3607f)
                curveTo(10.8607f, 11.2615f, 10.4507f, 11.0415f, 10.2307f, 10.6715f)
                curveTo(10.0107f, 10.2915f, 10.0307f, 9.8315f, 10.2807f, 9.3915f)
                lineTo(11.3507f, 7.5315f)
                curveTo(11.5607f, 7.1715f, 12.0207f, 7.0515f, 12.3707f, 7.2515f)
                curveTo(12.7307f, 7.4615f, 12.8507f, 7.9215f, 12.6507f, 8.2715f)
                lineTo(11.8007f, 9.7515f)
                horizontalLineTo(12.6407f)
                curveTo(13.1407f, 9.7515f, 13.5507f, 9.9715f, 13.7707f, 10.3415f)
                curveTo(13.9907f, 10.7215f, 13.9707f, 11.1915f, 13.7207f, 11.6215f)
                close()
            }
        }
        .build()
