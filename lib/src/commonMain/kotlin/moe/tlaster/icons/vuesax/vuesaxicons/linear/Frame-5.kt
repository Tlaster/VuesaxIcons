...
public val LinearGroup.`Frame-5`: ImageVector
    get() {
        if (`_frame-5` != null) {
            return `_frame-5`!!
        }
        `_frame-5` = Builder(name = "Frame-5", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_frame-5`: ImageVector? = null
