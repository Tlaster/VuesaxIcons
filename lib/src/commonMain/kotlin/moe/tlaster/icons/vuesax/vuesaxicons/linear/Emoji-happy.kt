...
public val LinearGroup.`Emoji-happy`: ImageVector
    get() {
        if (`_emoji-happy` != null) {
            return `_emoji-happy`!!
        }
        `_emoji-happy` = Builder(name = "Emoji-happy", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_emoji-happy`: ImageVector? = null
