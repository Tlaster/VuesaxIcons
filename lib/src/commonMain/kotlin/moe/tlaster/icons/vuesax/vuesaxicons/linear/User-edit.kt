...
public val LinearGroup.`User-edit`: ImageVector
    get() {
        if (`_user-edit` != null) {
            return `_user-edit`!!
        }
        `_user-edit` = Builder(name = "User-edit", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_user-edit`: ImageVector? = null
