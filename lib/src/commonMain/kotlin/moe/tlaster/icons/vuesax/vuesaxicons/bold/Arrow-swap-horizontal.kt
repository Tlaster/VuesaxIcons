...
public val BoldGroup.`Arrow-swap-horizontal`: ImageVector
    get() {
        if (`_arrow-swap-horizontal` != null) {
            return `_arrow-swap-horizontal`!!
        }
        `_arrow-swap-horizontal` = Builder(name = "Arrow-swap-horizontal", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(6.25f, 13.35f, 6.59f, 13.01f, 7.0f, 13.01f)
                ...
                curveTo(17.75f, 10.65f, 17.41f, 10.99f, 17.0f, 10.99f)
                close()
            }
        }
        .build()
...
private var `_arrow-swap-horizontal`: ImageVector? = null
