...
public val BulkGroup.`Avalanche-(avax)`: ImageVector
    get() {
        ...
        `_avalanche-(avax)` = Builder(name = "Avalanche-(avax)", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(15.2401f, 12.3703f)
                lineTo(13.3201f, 15.5703f)
                curveTo(13.1401f, 15.8703f, 13.3601f, 16.2603f, 13.7101f, 16.2603f)
                horizontalLineTo(17.5501f)
                curveTo(17.9001f, 16.2603f, 18.1201f, 15.8803f, 17.9401f, 15.5703f)
                lineTo(16.0201f, 12.3703f)
                curveTo(15.8501f, 12.0803f, 15.4201f, 12.0803f, 15.2401f, 12.3703f)
                close()
            }
