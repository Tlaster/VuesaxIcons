...
public val LinearGroup.`Volumelow-1`: ImageVector
    get() {
        if (`_volumelow-1` != null) {
            return `_volumelow-1`!!
        }
        `_volumelow-1` = Builder(name = "Volumelow-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_volumelow-1`: ImageVector? = null
