...
public val LinearGroup.`Percentage-square`: ImageVector
    get() {
        if (`_percentage-square` != null) {
            return `_percentage-square`!!
        }
        `_percentage-square` = Builder(name = "Percentage-square", defaultWidth = 24.0.dp,
...
private var `_percentage-square`: ImageVector? = null
