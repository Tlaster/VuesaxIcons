...
public val LinearGroup.Zelzel: ImageVector
    get() {
        if (_zelzel != null) {
            return _zelzel!!
        }
        _zelzel = Builder(name = "Zelzel", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF17191C)),
                    strokeLineWidth = 1.5f, strokeLineCap = Butt, strokeLineJoin = Round,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(14.8002f, 9.3f)
                verticalLineTo(10.7f)
                lineTo(13.5002f, 11.5f)
                verticalLineTo(13.2f)
                lineTo(12.0002f, 14.1f)
                lineTo(10.5002f, 13.2f)
                verticalLineTo(11.5f)
                lineTo(9.2002f, 10.7f)
                verticalLineTo(9.3f)
                lineTo(12.0002f, 7.8f)
                lineTo(14.8002f, 9.3f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF17191C)),
                    strokeLineWidth = 1.5f, strokeLineCap = Butt, strokeLineJoin = Round,
