...
public val LinearGroup.`Gallery-tick`: ImageVector
    get() {
        if (`_gallery-tick` != null) {
            return `_gallery-tick`!!
        }
        `_gallery-tick` = Builder(name = "Gallery-tick", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_gallery-tick`: ImageVector? = null
