...
public val LinearGroup.`Buy-crypto`: ImageVector
    get() {
        if (`_buy-crypto` != null) {
            return `_buy-crypto`!!
        }
        `_buy-crypto` = Builder(name = "Buy-crypto", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_buy-crypto`: ImageVector? = null
