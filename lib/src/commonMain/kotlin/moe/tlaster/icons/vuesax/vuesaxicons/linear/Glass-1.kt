...
public val LinearGroup.`Glass-1`: ImageVector
    get() {
        if (`_glass-1` != null) {
            return `_glass-1`!!
        }
        `_glass-1` = Builder(name = "Glass-1", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_glass-1`: ImageVector? = null
