...
public val LinearGroup.`Password-check`: ImageVector
    get() {
        if (`_password-check` != null) {
            return `_password-check`!!
        }
        `_password-check` = Builder(name = "Password-check", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_password-check`: ImageVector? = null
