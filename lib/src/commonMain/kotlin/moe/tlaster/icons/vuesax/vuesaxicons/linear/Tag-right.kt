...
public val LinearGroup.`Tag-right`: ImageVector
    get() {
        if (`_tag-right` != null) {
            return `_tag-right`!!
        }
        `_tag-right` = Builder(name = "Tag-right", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_tag-right`: ImageVector? = null
