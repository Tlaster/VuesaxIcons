...
public val BoldGroup.`Search-status-1`: ImageVector
    get() {
        if (`_search-status-1` != null) {
            return `_search-status-1`!!
        }
        `_search-status-1` = Builder(name = "Search-status-1", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.09f, 13.75f, 7.75f, 13.41f, 7.75f, 13.0f)
                curveTo(7.75f, 12.59f, 8.09f, 12.25f, 8.5f, 12.25f)
                horizontalLineTo(11.5f)
                curveTo(11.91f, 12.25f, 12.25f, 12.59f, 12.25f, 13.0f)
                curveTo(12.25f, 13.41f, 11.91f, 13.75f, 11.5f, 13.75f)
                close()
                moveTo(14.5f, 10.75f)
                horizontalLineTo(8.5f)
                curveTo(8.09f, 10.75f, 7.75f, 10.41f, 7.75f, 10.0f)
...
private var `_search-status-1`: ImageVector? = null
