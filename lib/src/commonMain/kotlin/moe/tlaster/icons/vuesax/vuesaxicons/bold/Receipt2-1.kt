...
public val BoldGroup.`Receipt2-1`: ImageVector
    get() {
        if (`_receipt2-1` != null) {
            return `_receipt2-1`!!
        }
        `_receipt2-1` = Builder(name = "Receipt2-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_receipt2-1`: ImageVector? = null
