...
public val BoldGroup.`Play-circle`: ImageVector
    get() {
        ...
        `_play-circle` = Builder(name = "Play-circle", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(11.7087f, 16.11f, 11.3087f, 16.21f, 10.9187f, 16.21f)
                curveTo(10.5187f, 16.21f, 10.1288f, 16.11f, 9.7688f, 15.9f)
                ...
                curveTo(16.1287f, 13.06f, 15.6988f, 13.81f, 14.9688f, 14.23f)
                close()
            }
        }
        .build()
