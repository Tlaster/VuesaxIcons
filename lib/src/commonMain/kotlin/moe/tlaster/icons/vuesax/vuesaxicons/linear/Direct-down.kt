...
public val LinearGroup.`Direct-down`: ImageVector
    get() {
        if (`_direct-down` != null) {
            return `_direct-down`!!
        }
        `_direct-down` = Builder(name = "Direct-down", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_direct-down`: ImageVector? = null
