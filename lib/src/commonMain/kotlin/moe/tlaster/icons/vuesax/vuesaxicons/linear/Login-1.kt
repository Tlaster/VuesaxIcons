...
public val LinearGroup.`Login-1`: ImageVector
    get() {
        if (`_login-1` != null) {
            return `_login-1`!!
        }
        `_login-1` = Builder(name = "Login-1", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_login-1`: ImageVector? = null
