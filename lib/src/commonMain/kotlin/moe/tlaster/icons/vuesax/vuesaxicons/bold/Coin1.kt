...
public val BoldGroup.Coin1: ImageVector
    get() {
        if (_coin1 != null) {
            return _coin1!!
        }
        _coin1 = Builder(name = "Coin1", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(12.0f, 22.7484f)
                curveTo(8.0f, 22.7484f, 4.75f, 19.8784f, 4.75f, 16.3484f)
                verticalLineTo(12.6484f)
                curveTo(4.75f, 12.2384f, 5.09f, 11.8984f, 5.5f, 11.8984f)
                curveTo(5.91f, 11.8984f, 6.25f, 12.2384f, 6.25f, 12.6484f)
                curveTo(6.25f, 15.2684f, 8.72f, 17.2484f, 12.0f, 17.2484f)
                curveTo(15.28f, 17.2484f, 17.75f, 15.2684f, 17.75f, 12.6484f)
                curveTo(17.75f, 12.2384f, 18.09f, 11.8984f, 18.5f, 11.8984f)
                curveTo(18.91f, 11.8984f, 19.25f, 12.2384f, 19.25f, 12.6484f)
                verticalLineTo(16.3484f)
                curveTo(19.25f, 19.8784f, 16.0f, 22.7484f, 12.0f, 22.7484f)
                close()
                moveTo(6.25f, 16.4584f)
                curveTo(6.32f, 19.1084f, 8.87f, 21.2484f, 12.0f, 21.2484f)
                curveTo(15.13f, 21.2484f, 17.68f, 19.1084f, 17.75f, 16.4584f)
                curveTo(16.45f, 17.8684f, 14.39f, 18.7484f, 12.0f, 18.7484f)
                curveTo(9.61f, 18.7484f, 7.56f, 17.8684f, 6.25f, 16.4584f)
                close()
            }
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
