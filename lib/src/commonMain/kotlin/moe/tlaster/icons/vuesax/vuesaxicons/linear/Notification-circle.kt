...
public val LinearGroup.`Notification-circle`: ImageVector
    get() {
        if (`_notification-circle` != null) {
            return `_notification-circle`!!
        }
        `_notification-circle` = Builder(name = "Notification-circle", defaultWidth = 24.0.dp,
...
private var `_notification-circle`: ImageVector? = null
