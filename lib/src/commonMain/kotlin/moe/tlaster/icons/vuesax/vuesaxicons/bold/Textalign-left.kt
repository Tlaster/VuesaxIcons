...
public val BoldGroup.`Textalign-left`: ImageVector
    get() {
        if (`_textalign-left` != null) {
            return `_textalign-left`!!
        }
        `_textalign-left` = Builder(name = "Textalign-left", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_textalign-left`: ImageVector? = null
