...
public val BoldGroup.`Textblock-1`: ImageVector
    get() {
        if (`_textblock-1` != null) {
            return `_textblock-1`!!
        }
        `_textblock-1` = Builder(name = "Textblock-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_textblock-1`: ImageVector? = null
