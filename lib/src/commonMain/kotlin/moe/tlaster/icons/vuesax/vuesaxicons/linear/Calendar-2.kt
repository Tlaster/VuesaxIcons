...
public val LinearGroup.`Calendar-2`: ImageVector
    get() {
        if (`_calendar-2` != null) {
            return `_calendar-2`!!
        }
        `_calendar-2` = Builder(name = "Calendar-2", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_calendar-2`: ImageVector? = null
