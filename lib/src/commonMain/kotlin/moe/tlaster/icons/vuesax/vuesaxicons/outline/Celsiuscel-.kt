...
public val OutlineGroup.`Celsiuscel-`: ImageVector
    get() {
        if (`_celsiuscel-` != null) {
            return `_celsiuscel-`!!
        }
        `_celsiuscel-` = Builder(name = "Celsiuscel-", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_celsiuscel-`: ImageVector? = null
