...
public val LinearGroup.Bank: ImageVector
    get() {
        if (_bank != null) {
            return _bank!!
        }
        _bank = Builder(name = "Bank", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                moveTo(12.37f, 2.1501f)
                lineTo(21.37f, 5.7501f)
                curveTo(21.72f, 5.8901f, 22.0f, 6.3101f, 22.0f, 6.6801f)
                verticalLineTo(10.0001f)
                curveTo(22.0f, 10.5501f, 21.55f, 11.0001f, 21.0f, 11.0001f)
                horizontalLineTo(3.0f)
                curveTo(2.45f, 11.0001f, 2.0f, 10.5501f, 2.0f, 10.0001f)
                verticalLineTo(6.6801f)
                curveTo(2.0f, 6.3101f, 2.28f, 5.8901f, 2.63f, 5.7501f)
                lineTo(11.63f, 2.1501f)
                curveTo(11.83f, 2.0701f, 12.17f, 2.0701f, 12.37f, 2.1501f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
