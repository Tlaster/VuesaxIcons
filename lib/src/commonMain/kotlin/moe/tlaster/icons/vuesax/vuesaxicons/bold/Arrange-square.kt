...
public val BoldGroup.`Arrange-square`: ImageVector
    get() {
        if (`_arrange-square` != null) {
            return `_arrange-square`!!
        }
        `_arrange-square` = Builder(name = "Arrange-square", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_arrange-square`: ImageVector? = null
