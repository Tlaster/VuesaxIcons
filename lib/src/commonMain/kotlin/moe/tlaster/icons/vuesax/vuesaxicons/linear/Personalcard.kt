...
public val LinearGroup.Personalcard: ImageVector
    get() {
        ...
        _personalcard = Builder(name = "Personalcard", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(8.4999f, 11.2899f)
                curveTo(9.4996f, 11.2899f, 10.3099f, 10.4796f, 10.3099f, 9.4799f)
                curveTo(10.3099f, 8.4803f, 9.4996f, 7.6699f, 8.4999f, 7.6699f)
                curveTo(7.5003f, 7.6699f, 6.6899f, 8.4803f, 6.6899f, 9.4799f)
                curveTo(6.6899f, 10.4796f, 7.5003f, 11.2899f, 8.4999f, 11.2899f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
