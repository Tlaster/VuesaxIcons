...
public val BoldGroup.`Receipt-add`: ImageVector
    get() {
        if (`_receipt-add` != null) {
            return `_receipt-add`!!
        }
        `_receipt-add` = Builder(name = "Receipt-add", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_receipt-add`: ImageVector? = null
