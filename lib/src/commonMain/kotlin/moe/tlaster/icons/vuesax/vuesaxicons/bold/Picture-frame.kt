...
public val BoldGroup.`Picture-frame`: ImageVector
    get() {
        if (`_picture-frame` != null) {
            return `_picture-frame`!!
        }
        `_picture-frame` = Builder(name = "Picture-frame", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_picture-frame`: ImageVector? = null
