...
public val LinearGroup.`Maincomponent-1`: ImageVector
    get() {
        if (`_maincomponent-1` != null) {
            return `_maincomponent-1`!!
        }
        `_maincomponent-1` = Builder(name = "Maincomponent-1", defaultWidth = 24.0.dp, defaultHeight
...
private var `_maincomponent-1`: ImageVector? = null
