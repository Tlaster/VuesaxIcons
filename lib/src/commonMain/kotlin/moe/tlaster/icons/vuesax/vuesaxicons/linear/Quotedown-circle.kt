...
public val LinearGroup.`Quotedown-circle`: ImageVector
    get() {
        if (`_quotedown-circle` != null) {
            return `_quotedown-circle`!!
        }
        `_quotedown-circle` = Builder(name = "Quotedown-circle", defaultWidth = 24.0.dp,
...
private var `_quotedown-circle`: ImageVector? = null
