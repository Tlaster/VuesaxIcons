...
public val LinearGroup.`Refresh-square-2`: ImageVector
    get() {
        if (`_refresh-square-2` != null) {
            return `_refresh-square-2`!!
        }
        `_refresh-square-2` = Builder(name = "Refresh-square-2", defaultWidth = 24.0.dp,
...
private var `_refresh-square-2`: ImageVector? = null
