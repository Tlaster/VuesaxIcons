...
public val BoldGroup.`Arrowleft-3`: ImageVector
    get() {
        if (`_arrowleft-3` != null) {
            return `_arrowleft-3`!!
        }
        `_arrowleft-3` = Builder(name = "Arrowleft-3", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_arrowleft-3`: ImageVector? = null
