...
public val LinearGroup.`Receipt-discount`: ImageVector
    get() {
        if (`_receipt-discount` != null) {
            return `_receipt-discount`!!
        }
        `_receipt-discount` = Builder(name = "Receipt-discount", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    ...
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(11.9247f, 13.5f)
                horizontalLineTo(11.9337f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(6.1947f, 8.5f)
                horizontalLineTo(6.2037f)
            }
        }
        .build()
        return `_receipt-discount`!!
...
private var `_receipt-discount`: ImageVector? = null
