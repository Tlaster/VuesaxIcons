...
public val BoldGroup.`Task-square`: ImageVector
    get() {
        if (`_task-square` != null) {
            return `_task-square`!!
        }
        `_task-square` = Builder(name = "Task-square", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(7.0f, 17.37f, 6.8f, 17.3f, 6.66f, 17.15f)
                lineTo(5.91f, 16.4f)
                ...
                curveTo(7.0f, 10.37f, 6.8f, 10.3f, 6.66f, 10.15f)
                lineTo(5.91f, 9.4f)
...
private var `_task-square`: ImageVector? = null
