...
public val LinearGroup.`Hometrend-up`: ImageVector
    get() {
        if (`_hometrend-up` != null) {
            return `_hometrend-up`!!
        }
        `_hometrend-up` = Builder(name = "Hometrend-up", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_hometrend-up`: ImageVector? = null
