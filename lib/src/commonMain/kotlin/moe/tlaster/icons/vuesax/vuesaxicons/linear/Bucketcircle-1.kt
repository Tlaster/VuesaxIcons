...
public val LinearGroup.`Bucketcircle-1`: ImageVector
    get() {
        if (`_bucketcircle-1` != null) {
            return `_bucketcircle-1`!!
        }
        `_bucketcircle-1` = Builder(name = "Bucketcircle-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_bucketcircle-1`: ImageVector? = null
