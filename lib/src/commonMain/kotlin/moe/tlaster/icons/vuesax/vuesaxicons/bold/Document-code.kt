...
public val BoldGroup.`Document-code`: ImageVector
    get() {
        if (`_document-code` != null) {
            return `_document-code`!!
        }
        `_document-code` = Builder(name = "Document-code", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(10.38f, 17.68f, 10.19f, 17.75f, 10.0f, 17.75f)
                ...
                curveTo(14.38f, 17.68f, 14.19f, 17.75f, 14.0f, 17.75f)
...
private var `_document-code`: ImageVector? = null
