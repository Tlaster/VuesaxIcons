...
public val BoldGroup.`Textalign-justifycenter-1`: ImageVector
    get() {
        if (`_textalign-justifycenter-1` != null) {
            return `_textalign-justifycenter-1`!!
        }
        `_textalign-justifycenter-1` = Builder(name = "Textalign-justifycenter-1", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(2.25f, 9.09f, 2.59f, 8.75f, 3.0f, 8.75f)
                horizontalLineTo(21.0f)
...
private var `_textalign-justifycenter-1`: ImageVector? = null
