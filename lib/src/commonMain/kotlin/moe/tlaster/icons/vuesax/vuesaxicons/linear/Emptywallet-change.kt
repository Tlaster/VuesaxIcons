...
public val LinearGroup.`Emptywallet-change`: ImageVector
    get() {
        if (`_emptywallet-change` != null) {
            return `_emptywallet-change`!!
        }
        `_emptywallet-change` = Builder(name = "Emptywallet-change", defaultWidth = 24.0.dp,
...
private var `_emptywallet-change`: ImageVector? = null
