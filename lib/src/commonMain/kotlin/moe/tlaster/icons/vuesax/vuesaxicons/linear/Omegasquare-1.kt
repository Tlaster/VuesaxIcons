...
public val LinearGroup.`Omegasquare-1`: ImageVector
    get() {
        if (`_omegasquare-1` != null) {
            return `_omegasquare-1`!!
        }
        `_omegasquare-1` = Builder(name = "Omegasquare-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_omegasquare-1`: ImageVector? = null
