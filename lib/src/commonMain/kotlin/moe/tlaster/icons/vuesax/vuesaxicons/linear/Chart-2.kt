...
public val LinearGroup.`Chart-2`: ImageVector
    get() {
        if (`_chart-2` != null) {
            return `_chart-2`!!
        }
        `_chart-2` = Builder(name = "Chart-2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_chart-2`: ImageVector? = null
