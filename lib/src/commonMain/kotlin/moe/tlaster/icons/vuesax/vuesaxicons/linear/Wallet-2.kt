...
public val LinearGroup.`Wallet-2`: ImageVector
    get() {
        if (`_wallet-2` != null) {
            return `_wallet-2`!!
        }
        `_wallet-2` = Builder(name = "Wallet-2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_wallet-2`: ImageVector? = null
