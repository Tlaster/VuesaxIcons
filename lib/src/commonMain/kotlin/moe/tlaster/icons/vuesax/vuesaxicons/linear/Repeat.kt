...
public val LinearGroup.Repeat: ImageVector
    get() {
        if (_repeat != null) {
            return _repeat!!
        }
        _repeat = Builder(name = "Repeat", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                moveTo(3.58f, 5.1599f)
                horizontalLineTo(17.42f)
                curveTo(19.08f, 5.1599f, 20.42f, 6.4999f, 20.42f, 8.1599f)
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(17.26f, 21.9999f)
                lineTo(20.42f, 18.84f)
                lineTo(17.26f, 15.6799f)
            }
        }
        .build()
        return _repeat!!
