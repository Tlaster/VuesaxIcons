...
public val LinearGroup.`Chart-21`: ImageVector
    get() {
        if (`_chart-21` != null) {
            return `_chart-21`!!
        }
        `_chart-21` = Builder(name = "Chart-21", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_chart-21`: ImageVector? = null
