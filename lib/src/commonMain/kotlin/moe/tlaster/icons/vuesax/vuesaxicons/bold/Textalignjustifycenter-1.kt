...
public val BoldGroup.`Textalignjustifycenter-1`: ImageVector
    get() {
        if (`_textalignjustifycenter-1` != null) {
            return `_textalignjustifycenter-1`!!
        }
        `_textalignjustifycenter-1` = Builder(name = "Textalignjustifycenter-1", defaultWidth =
...
private var `_textalignjustifycenter-1`: ImageVector? = null
