...
public val BoldGroup.`Usercirlce-add`: ImageVector
    get() {
        if (`_usercirlce-add` != null) {
            return `_usercirlce-add`!!
        }
        `_usercirlce-add` = Builder(name = "Usercirlce-add", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_usercirlce-add`: ImageVector? = null
