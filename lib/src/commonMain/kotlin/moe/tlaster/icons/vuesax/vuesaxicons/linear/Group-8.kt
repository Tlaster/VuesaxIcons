...
public val LinearGroup.`Group-8`: ImageVector
    get() {
        if (`_group-8` != null) {
            return `_group-8`!!
        }
        `_group-8` = Builder(name = "Group-8", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_group-8`: ImageVector? = null
