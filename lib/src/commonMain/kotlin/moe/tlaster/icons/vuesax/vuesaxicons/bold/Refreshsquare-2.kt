...
public val BoldGroup.`Refreshsquare-2`: ImageVector
    get() {
        if (`_refreshsquare-2` != null) {
            return `_refreshsquare-2`!!
        }
        `_refreshsquare-2` = Builder(name = "Refreshsquare-2", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.5f, 5.95f, 10.2f, 5.25f, 12.0f, 5.25f)
                ...
                curveTo(9.28f, 16.69f, 10.6f, 17.24f, 12.0f, 17.24f)
...
private var `_refreshsquare-2`: ImageVector? = null
