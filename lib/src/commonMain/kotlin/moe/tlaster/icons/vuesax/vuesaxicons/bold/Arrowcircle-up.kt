...
public val BoldGroup.`Arrowcircle-up`: ImageVector
    get() {
        if (`_arrowcircle-up` != null) {
            return `_arrowcircle-up`!!
        }
        `_arrowcircle-up` = Builder(name = "Arrowcircle-up", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_arrowcircle-up`: ImageVector? = null
