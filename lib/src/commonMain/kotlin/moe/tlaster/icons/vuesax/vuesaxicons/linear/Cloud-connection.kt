...
public val LinearGroup.`Cloud-connection`: ImageVector
    get() {
        if (`_cloud-connection` != null) {
            return `_cloud-connection`!!
        }
        `_cloud-connection` = Builder(name = "Cloud-connection", defaultWidth = 24.0.dp,
...
private var `_cloud-connection`: ImageVector? = null
