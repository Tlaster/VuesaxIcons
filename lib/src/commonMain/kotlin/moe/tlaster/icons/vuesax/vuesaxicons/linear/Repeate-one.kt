...
public val LinearGroup.`Repeate-one`: ImageVector
    get() {
        if (`_repeate-one` != null) {
            return `_repeate-one`!!
        }
        `_repeate-one` = Builder(name = "Repeate-one", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_repeate-one`: ImageVector? = null
