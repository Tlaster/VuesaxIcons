...
public val LinearGroup.`Frame-3`: ImageVector
    get() {
        if (`_frame-3` != null) {
            return `_frame-3`!!
        }
        `_frame-3` = Builder(name = "Frame-3", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_frame-3`: ImageVector? = null
