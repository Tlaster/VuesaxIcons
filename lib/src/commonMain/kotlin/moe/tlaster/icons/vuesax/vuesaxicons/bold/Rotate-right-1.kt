...
public val BoldGroup.`Rotate-right-1`: ImageVector
    get() {
        if (`_rotate-right-1` != null) {
            return `_rotate-right-1`!!
        }
        `_rotate-right-1` = Builder(name = "Rotate-right-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_rotate-right-1`: ImageVector? = null
