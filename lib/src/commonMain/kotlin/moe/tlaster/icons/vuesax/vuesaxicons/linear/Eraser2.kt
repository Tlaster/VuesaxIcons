...
public val LinearGroup.Eraser2: ImageVector
    get() {
        if (_eraser2 != null) {
            return _eraser2!!
        }
        _eraser2 = Builder(name = "Eraser2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _eraser2: ImageVector? = null
