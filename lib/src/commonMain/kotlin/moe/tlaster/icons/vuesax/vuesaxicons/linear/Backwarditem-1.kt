...
public val LinearGroup.`Backwarditem-1`: ImageVector
    get() {
        if (`_backwarditem-1` != null) {
            return `_backwarditem-1`!!
        }
        `_backwarditem-1` = Builder(name = "Backwarditem-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_backwarditem-1`: ImageVector? = null
