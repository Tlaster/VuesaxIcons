...
public val TwotoneGroup.Ontologyont: ImageVector
    get() {
        if (_ontologyont != null) {
            return _ontologyont!!
        }
        _ontologyont = Builder(name = "Ontologyont", defaultWidth = 24.0.dp, defaultHeight =
...
private var _ontologyont: ImageVector? = null
