...
public val LinearGroup.`Message-programming`: ImageVector
    get() {
        if (`_message-programming` != null) {
            return `_message-programming`!!
        }
        `_message-programming` = Builder(name = "Message-programming", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                lineTo(9.3f, 19.37f)
                curveTo(9.14f, 19.15f, 8.78f, 18.97f, 8.5f, 18.97f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
...
private var `_message-programming`: ImageVector? = null
