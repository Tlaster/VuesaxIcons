...
public val BoldGroup.`Receipt-2-1`: ImageVector
    get() {
        if (`_receipt-2-1` != null) {
            return `_receipt-2-1`!!
        }
        `_receipt-2-1` = Builder(name = "Receipt-2-1", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(12.96f, 2.81f)
                curveTo(12.56f, 2.27f, 12.03f, 2.0f, 11.5f, 2.0f)
                curveTo(10.97f, 2.0f, 10.44f, 2.27f, 10.04f, 2.81f)
                lineTo(9.02f, 4.16f)
                ...
                curveTo(3.14f, 4.44f, 3.0f, 5.52f, 3.0f, 7.04f)
                verticalLineTo(16.96f)
                curveTo(3.0f, 18.48f, 3.14f, 19.56f, 3.5f, 20.33f)
                ...
                curveTo(10.44f, 21.73f, 10.97f, 22.0f, 11.5f, 22.0f)
                curveTo(12.03f, 22.0f, 12.56f, 21.73f, 12.96f, 21.19f)
                ...
                curveTo(19.86f, 19.56f, 20.0f, 18.48f, 20.0f, 16.96f)
                verticalLineTo(7.04f)
                curveTo(20.0f, 5.52f, 19.86f, 4.44f, 19.5f, 3.67f)
                close()
                moveTo(14.0f, 14.5f)
                horizontalLineTo(8.0f)
                curveTo(7.59f, 14.5f, 7.25f, 14.16f, 7.25f, 13.75f)
                curveTo(7.25f, 13.34f, 7.59f, 13.0f, 8.0f, 13.0f)
                horizontalLineTo(14.0f)
                curveTo(14.41f, 13.0f, 14.75f, 13.34f, 14.75f, 13.75f)
                curveTo(14.75f, 14.16f, 14.41f, 14.5f, 14.0f, 14.5f)
                close()
                moveTo(16.0f, 11.0f)
                horizontalLineTo(8.0f)
                curveTo(7.59f, 11.0f, 7.25f, 10.66f, 7.25f, 10.25f)
                curveTo(7.25f, 9.84f, 7.59f, 9.5f, 8.0f, 9.5f)
                horizontalLineTo(16.0f)
                curveTo(16.41f, 9.5f, 16.75f, 9.84f, 16.75f, 10.25f)
                curveTo(16.75f, 10.66f, 16.41f, 11.0f, 16.0f, 11.0f)
                close()
            }
        }
        .build()
...
private var `_receipt-2-1`: ImageVector? = null
