...
public val LinearGroup.`Group-6`: ImageVector
    get() {
        if (`_group-6` != null) {
            return `_group-6`!!
        }
        `_group-6` = Builder(name = "Group-6", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_group-6`: ImageVector? = null
