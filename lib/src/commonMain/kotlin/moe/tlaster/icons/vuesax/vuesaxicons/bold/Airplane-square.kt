...
public val BoldGroup.`Airplane-square`: ImageVector
    get() {
        if (`_airplane-square` != null) {
            return `_airplane-square`!!
        }
        `_airplane-square` = Builder(name = "Airplane-square", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(15.01f, 19.0f, 14.53f, 19.2f, 14.14f, 19.0f)
                lineTo(12.47f, 17.58f)
                curveTo(12.21f, 17.37f, 11.79f, 17.37f, 11.54f, 17.58f)
                lineTo(9.86f, 19.0f)
                curveTo(9.46f, 19.2f, 8.99f, 19.0f, 8.85f, 18.57f)
                lineTo(8.53f, 17.61f)
...
private var `_airplane-square`: ImageVector? = null
