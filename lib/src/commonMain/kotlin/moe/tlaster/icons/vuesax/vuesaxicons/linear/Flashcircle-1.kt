...
public val LinearGroup.`Flashcircle-1`: ImageVector
    get() {
        if (`_flashcircle-1` != null) {
            return `_flashcircle-1`!!
        }
        `_flashcircle-1` = Builder(name = "Flashcircle-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_flashcircle-1`: ImageVector? = null
