...
public val LinearGroup.`Flash-1`: ImageVector
    get() {
        if (`_flash-1` != null) {
            return `_flash-1`!!
        }
        `_flash-1` = Builder(name = "Flash-1", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_flash-1`: ImageVector? = null
