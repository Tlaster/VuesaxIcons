...
public val BoldGroup.`Textitalic-1`: ImageVector
    get() {
        if (`_textitalic-1` != null) {
            return `_textitalic-1`!!
        }
        `_textitalic-1` = Builder(name = "Textitalic-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_textitalic-1`: ImageVector? = null
