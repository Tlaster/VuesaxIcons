...
public val LinearGroup.`Emptywallet-time`: ImageVector
    get() {
        if (`_emptywallet-time` != null) {
            return `_emptywallet-time`!!
        }
        `_emptywallet-time` = Builder(name = "Emptywallet-time", defaultWidth = 24.0.dp,
...
private var `_emptywallet-time`: ImageVector? = null
