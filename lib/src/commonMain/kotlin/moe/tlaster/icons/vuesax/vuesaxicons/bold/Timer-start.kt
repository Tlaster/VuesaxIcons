...
public val BoldGroup.`Timer-start`: ImageVector
    get() {
        if (`_timer-start` != null) {
            return `_timer-start`!!
        }
        `_timer-start` = Builder(name = "Timer-start", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(15.0f, 21.24f, 15.76f, 22.0f, 17.03f, 22.0f)
...
private var `_timer-start`: ImageVector? = null
