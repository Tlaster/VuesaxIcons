...
public val BoldGroup.`Attach-circle`: ImageVector
    get() {
        ...
        `_attach-circle` = Builder(name = "Attach-circle", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, fillAlpha = 0.93f, strokeAlpha
                    = 0.93f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                ...
                curveTo(6.44f, 15.18f, 6.0f, 14.13f, 6.0f, 13.01f)
                curveTo(6.0f, 11.89f, 6.43f, 10.84f, 7.22f, 10.05f)
                lineTo(9.64f, 7.63f)
