...
public val BoldGroup.`Arrowdown-1`: ImageVector
    get() {
        if (`_arrowdown-1` != null) {
            return `_arrowdown-1`!!
        }
        `_arrowdown-1` = Builder(name = "Arrowdown-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_arrowdown-1`: ImageVector? = null
