...
public val LinearGroup.`Omegacircle-1`: ImageVector
    get() {
        if (`_omegacircle-1` != null) {
            return `_omegacircle-1`!!
        }
        `_omegacircle-1` = Builder(name = "Omegacircle-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_omegacircle-1`: ImageVector? = null
