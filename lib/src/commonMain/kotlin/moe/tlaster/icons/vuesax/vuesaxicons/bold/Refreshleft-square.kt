...
public val BoldGroup.`Refreshleft-square`: ImageVector
    get() {
        if (`_refreshleft-square` != null) {
            return `_refreshleft-square`!!
        }
        `_refreshleft-square` = Builder(name = "Refreshleft-square", defaultWidth = 24.0.dp,
...
private var `_refreshleft-square`: ImageVector? = null
