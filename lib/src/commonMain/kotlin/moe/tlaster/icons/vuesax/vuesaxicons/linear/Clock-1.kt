...
public val LinearGroup.`Clock-1`: ImageVector
    get() {
        if (`_clock-1` != null) {
            return `_clock-1`!!
        }
        `_clock-1` = Builder(name = "Clock-1", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_clock-1`: ImageVector? = null
