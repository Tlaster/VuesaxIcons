...
public val BoldGroup.`Add-circle`: ImageVector
    get() {
        if (`_add-circle` != null) {
            return `_add-circle`!!
        }
        `_add-circle` = Builder(name = "Add-circle", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_add-circle`: ImageVector? = null
