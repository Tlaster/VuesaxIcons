...
public val BoldGroup.Mask: ImageVector
    get() {
        if (_mask != null) {
            return _mask!!
        }
        _mask = Builder(name = "Mask", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(20.6893f, 17.6012f, 21.9693f, 14.9413f, 21.9693f, 12.0013f)
                curveTo(21.9693f, 9.0612f, 20.6893f, 6.4012f, 18.6493f, 4.5912f)
                close()
                moveTo(11.9693f, 16.3912f)
                curveTo(11.9493f, 18.0412f, 10.7193f, 18.4412f, 9.5693f, 17.9812f)
