...
public val LinearGroup.`_3d-square`: ImageVector
    get() {
        if (`__3d-square` != null) {
            return `__3d-square`!!
        }
        `__3d-square` = Builder(name = "_3d-square", defaultWidth = 24.0.dp, defaultHeight =
...
private var `__3d-square`: ImageVector? = null
