...
public val LinearGroup.`Toggleon-circle`: ImageVector
    get() {
        if (`_toggleon-circle` != null) {
            return `_toggleon-circle`!!
        }
        `_toggleon-circle` = Builder(name = "Toggleon-circle", defaultWidth = 24.0.dp, defaultHeight
...
private var `_toggleon-circle`: ImageVector? = null
