...
public val OutlineGroup.`Augur-(rep)`: ImageVector
    get() {
        if (`_augur-(rep)` != null) {
            return `_augur-(rep)`!!
        }
        `_augur-(rep)` = Builder(name = "Augur-(rep)", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_augur-(rep)`: ImageVector? = null
