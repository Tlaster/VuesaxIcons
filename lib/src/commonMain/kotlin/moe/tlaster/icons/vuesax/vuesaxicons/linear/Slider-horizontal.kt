...
public val LinearGroup.`Slider-horizontal`: ImageVector
    get() {
        if (`_slider-horizontal` != null) {
            return `_slider-horizontal`!!
        }
        `_slider-horizontal` = Builder(name = "Slider-horizontal", defaultWidth = 24.0.dp,
...
private var `_slider-horizontal`: ImageVector? = null
