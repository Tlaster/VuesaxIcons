...
public val LinearGroup.`Forward-item-1`: ImageVector
    get() {
        if (`_forward-item-1` != null) {
            return `_forward-item-1`!!
        }
        `_forward-item-1` = Builder(name = "Forward-item-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_forward-item-1`: ImageVector? = null
