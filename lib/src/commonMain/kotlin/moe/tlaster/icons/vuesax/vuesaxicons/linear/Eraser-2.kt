...
public val LinearGroup.`Eraser-2`: ImageVector
    get() {
        if (`_eraser-2` != null) {
            return `_eraser-2`!!
        }
        `_eraser-2` = Builder(name = "Eraser-2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_eraser-2`: ImageVector? = null
