...
public val BoldGroup.`Battery-empty-1`: ImageVector
    get() {
        if (`_battery-empty-1` != null) {
            return `_battery-empty-1`!!
        }
        `_battery-empty-1` = Builder(name = "Battery-empty-1", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(6.59f, 9.1691f, 7.0f, 9.4191f, 7.1f, 9.8191f)
...
private var `_battery-empty-1`: ImageVector? = null
