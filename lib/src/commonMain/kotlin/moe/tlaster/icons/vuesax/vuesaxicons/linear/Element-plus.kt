...
public val LinearGroup.`Element-plus`: ImageVector
    get() {
        if (`_element-plus` != null) {
            return `_element-plus`!!
        }
        `_element-plus` = Builder(name = "Element-plus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_element-plus`: ImageVector? = null
