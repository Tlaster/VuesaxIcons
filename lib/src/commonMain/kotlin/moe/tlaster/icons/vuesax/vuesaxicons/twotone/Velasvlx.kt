...
public val TwotoneGroup.Velasvlx: ImageVector
    get() {
        if (_velasvlx != null) {
            return _velasvlx!!
        }
        _velasvlx = Builder(name = "Velasvlx", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _velasvlx: ImageVector? = null
