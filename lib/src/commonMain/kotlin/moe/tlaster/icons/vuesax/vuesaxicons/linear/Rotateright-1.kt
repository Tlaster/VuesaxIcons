...
public val LinearGroup.`Rotateright-1`: ImageVector
    get() {
        if (`_rotateright-1` != null) {
            return `_rotateright-1`!!
        }
        `_rotateright-1` = Builder(name = "Rotateright-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_rotateright-1`: ImageVector? = null
