...
public val BoldGroup.`Emoji-sad`: ImageVector
    get() {
        if (`_emoji-sad` != null) {
            return `_emoji-sad`!!
        }
        `_emoji-sad` = Builder(name = "Emoji-sad", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_emoji-sad`: ImageVector? = null
