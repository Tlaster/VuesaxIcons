...
public val LinearGroup.`Lamp-slash`: ImageVector
    get() {
        if (`_lamp-slash` != null) {
            return `_lamp-slash`!!
        }
        `_lamp-slash` = Builder(name = "Lamp-slash", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_lamp-slash`: ImageVector? = null
