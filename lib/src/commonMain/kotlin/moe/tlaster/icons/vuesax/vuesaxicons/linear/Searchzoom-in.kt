...
public val LinearGroup.`Searchzoom-in`: ImageVector
    get() {
        if (`_searchzoom-in` != null) {
            return `_searchzoom-in`!!
        }
        `_searchzoom-in` = Builder(name = "Searchzoom-in", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_searchzoom-in`: ImageVector? = null
