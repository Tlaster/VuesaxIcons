...
public val LinearGroup.`Timer-1`: ImageVector
    get() {
        if (`_timer-1` != null) {
            return `_timer-1`!!
        }
        `_timer-1` = Builder(name = "Timer-1", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_timer-1`: ImageVector? = null
