...
public val LinearGroup.`Video-square`: ImageVector
    get() {
        if (`_video-square` != null) {
            return `_video-square`!!
        }
        `_video-square` = Builder(name = "Video-square", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_video-square`: ImageVector? = null
