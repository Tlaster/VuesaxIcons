...
public val BoldGroup.`Repeat-circle`: ImageVector
    get() {
        if (`_repeat-circle` != null) {
            return `_repeat-circle`!!
        }
        `_repeat-circle` = Builder(name = "Repeat-circle", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(15.19f, 18.02f, 15.0f, 18.09f, 14.81f, 18.09f)
                ...
                curveTo(9.0f, 10.78f, 8.81f, 10.71f, 8.66f, 10.56f)
                lineTo(6.97f, 8.87f)
...
private var `_repeat-circle`: ImageVector? = null
