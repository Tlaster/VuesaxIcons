...
public val LinearGroup.`Messages-3`: ImageVector
    get() {
        if (`_messages-3` != null) {
            return `_messages-3`!!
        }
        `_messages-3` = Builder(name = "Messages-3", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_messages-3`: ImageVector? = null
