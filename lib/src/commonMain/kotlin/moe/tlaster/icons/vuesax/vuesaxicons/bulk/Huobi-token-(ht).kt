...
public val BulkGroup.`Huobi-token-(ht)`: ImageVector
    get() {
        ...
        `_huobi-token-(ht)` = Builder(name = "Huobi-token-(ht)", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, fillAlpha = 0.4f, strokeAlpha
                ...
                curveTo(9.9994f, 18.77f, 14.2094f, 21.64f, 14.7094f, 21.97f)
                curveTo(14.7394f, 21.99f, 14.7694f, 21.99f, 14.8094f, 21.97f)
