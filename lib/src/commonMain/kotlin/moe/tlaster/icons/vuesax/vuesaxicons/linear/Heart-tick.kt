...
public val LinearGroup.`Heart-tick`: ImageVector
    get() {
        if (`_heart-tick` != null) {
            return `_heart-tick`!!
        }
        `_heart-tick` = Builder(name = "Heart-tick", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_heart-tick`: ImageVector? = null
