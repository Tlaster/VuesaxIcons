...
public val BoldGroup.Documentprevious: ImageVector
    get() {
        if (_documentprevious != null) {
            return _documentprevious!!
        }
        _documentprevious = Builder(name = "Documentprevious", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(9.38f, 17.68f, 9.19f, 17.75f, 9.0f, 17.75f)
                ...
                curveTo(13.75f, 15.42f, 13.41f, 15.75f, 13.0f, 15.75f)
                close()
            }
        }
        .build()
