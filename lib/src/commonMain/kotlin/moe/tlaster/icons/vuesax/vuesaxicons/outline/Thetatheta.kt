...
public val OutlineGroup.Thetatheta: ImageVector
    get() {
        if (_thetatheta != null) {
            return _thetatheta!!
        }
        _thetatheta = Builder(name = "Thetatheta", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _thetatheta: ImageVector? = null
