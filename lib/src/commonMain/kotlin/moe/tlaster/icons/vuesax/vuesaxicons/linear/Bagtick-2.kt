...
public val LinearGroup.`Bagtick-2`: ImageVector
    get() {
        if (`_bagtick-2` != null) {
            return `_bagtick-2`!!
        }
        `_bagtick-2` = Builder(name = "Bagtick-2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    ...
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(10.44f, 15.0f)
                lineTo(11.09f, 15.65f)
                curveTo(11.28f, 15.84f, 11.59f, 15.85f, 11.78f, 15.66f)
                lineTo(13.56f, 14.02f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
...
private var `_bagtick-2`: ImageVector? = null
