...
public val BoldGroup.`Maximize-21`: ImageVector
    get() {
        if (`_maximize-21` != null) {
            return `_maximize-21`!!
        }
        `_maximize-21` = Builder(name = "Maximize-21", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_maximize-21`: ImageVector? = null
