...
public val LinearGroup.`Programming-arrows`: ImageVector
    get() {
        if (`_programming-arrows` != null) {
            return `_programming-arrows`!!
        }
        `_programming-arrows` = Builder(name = "Programming-arrows", defaultWidth = 24.0.dp,
...
private var `_programming-arrows`: ImageVector? = null
