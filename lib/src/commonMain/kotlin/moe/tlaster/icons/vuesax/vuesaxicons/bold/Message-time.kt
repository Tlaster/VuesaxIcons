...
public val BoldGroup.`Message-time`: ImageVector
    get() {
        if (`_message-time` != null) {
            return `_message-time`!!
        }
        `_message-time` = Builder(name = "Message-time", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(4.39f, 19.14f)
                curveTo(4.27f, 19.22f, 4.13f, 19.25f, 4.0f, 19.25f)
                ...
                curveTo(5.67f, 15.5f, 6.0f, 15.84f, 6.0f, 16.25f)
...
private var `_message-time`: ImageVector? = null
