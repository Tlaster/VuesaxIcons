...
public val BoldGroup.Moneytime: ImageVector
    get() {
        if (_moneytime != null) {
            return _moneytime!!
        }
        _moneytime = Builder(name = "Moneytime", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(1.0f, 20.21f, 2.79f, 22.0f, 5.0f, 22.0f)
                curveTo(7.21f, 22.0f, 9.0f, 20.21f, 9.0f, 18.0f)
                curveTo(9.0f, 15.79f, 7.21f, 14.0f, 5.0f, 14.0f)
                close()
                moveTo(6.0f, 17.68f)
                curveTo(6.0f, 18.29f, 5.67f, 18.87f, 5.15f, 19.18f)
                lineTo(4.39f, 19.64f)
                curveTo(4.27f, 19.72f, 4.13f, 19.75f, 4.0f, 19.75f)
                ...
                curveTo(4.5f, 16.34f, 4.84f, 16.0f, 5.25f, 16.0f)
                curveTo(5.66f, 16.0f, 6.0f, 16.34f, 6.0f, 16.75f)
