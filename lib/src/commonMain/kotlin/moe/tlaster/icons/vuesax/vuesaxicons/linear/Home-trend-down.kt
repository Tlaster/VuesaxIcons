...
public val LinearGroup.`Home-trend-down`: ImageVector
    get() {
        if (`_home-trend-down` != null) {
            return `_home-trend-down`!!
        }
        `_home-trend-down` = Builder(name = "Home-trend-down", defaultWidth = 24.0.dp, defaultHeight
...
private var `_home-trend-down`: ImageVector? = null
