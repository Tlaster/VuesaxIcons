...
public val BoldGroup.Galleryadd: ImageVector
    get() {
        if (_galleryadd != null) {
            return _galleryadd!!
        }
        _galleryadd = Builder(name = "Galleryadd", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(17.16f, 1.0f, 16.52f, 1.36f, 16.23f, 2.0f)
                curveTo(16.07f, 2.29f, 16.0f, 2.63f, 16.0f, 3.03f)
                verticalLineTo(5.97f)
                curveTo(16.0f, 7.24f, 16.76f, 8.0f, 18.03f, 8.0f)
                horizontalLineTo(20.97f)
                curveTo(21.37f, 8.0f, 21.71f, 7.93f, 22.0f, 7.77f)
                curveTo(22.64f, 7.48f, 23.0f, 6.84f, 23.0f, 5.97f)
                verticalLineTo(3.03f)
                curveTo(23.0f, 1.76f, 22.24f, 1.0f, 20.97f, 1.0f)
                close()
                moveTo(21.91f, 4.93f)
                curveTo(21.81f, 5.03f, 21.66f, 5.1f, 21.5f, 5.11f)
                horizontalLineTo(20.09f)
                verticalLineTo(5.62f)
                lineTo(20.1f, 6.5f)
                curveTo(20.09f, 6.67f, 20.03f, 6.81f, 19.91f, 6.93f)
                curveTo(19.81f, 7.03f, 19.66f, 7.1f, 19.5f, 7.1f)
                curveTo(19.17f, 7.1f, 18.9f, 6.83f, 18.9f, 6.5f)
                verticalLineTo(5.1f)
                lineTo(17.5f, 5.11f)
                curveTo(17.17f, 5.11f, 16.9f, 4.83f, 16.9f, 4.5f)
                curveTo(16.9f, 4.17f, 17.17f, 3.9f, 17.5f, 3.9f)
                lineTo(18.38f, 3.91f)
                horizontalLineTo(18.9f)
                verticalLineTo(2.51f)
                curveTo(18.9f, 2.18f, 19.17f, 1.9f, 19.5f, 1.9f)
                curveTo(19.83f, 1.9f, 20.1f, 2.18f, 20.1f, 2.51f)
                lineTo(20.09f, 3.22f)
                verticalLineTo(3.9f)
                horizontalLineTo(21.5f)
                curveTo(21.83f, 3.9f, 22.1f, 4.17f, 22.1f, 4.5f)
                curveTo(22.09f, 4.67f, 22.02f, 4.81f, 21.91f, 4.93f)
                close()
            }
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
