...
public val LinearGroup.`Forwarditem-1`: ImageVector
    get() {
        if (`_forwarditem-1` != null) {
            return `_forwarditem-1`!!
        }
        `_forwarditem-1` = Builder(name = "Forwarditem-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_forwarditem-1`: ImageVector? = null
