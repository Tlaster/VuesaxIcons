...
public val LinearGroup.`Scissor-2`: ImageVector
    get() {
        if (`_scissor-2` != null) {
            return `_scissor-2`!!
        }
        `_scissor-2` = Builder(name = "Scissor-2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_scissor-2`: ImageVector? = null
