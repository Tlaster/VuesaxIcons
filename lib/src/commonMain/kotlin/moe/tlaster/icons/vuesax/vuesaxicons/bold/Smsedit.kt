...
public val BoldGroup.Smsedit: ImageVector
    get() {
        if (_smsedit != null) {
            return _smsedit!!
        }
        _smsedit = Builder(name = "Smsedit", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(2.0f, 18.5f, 4.0f, 20.0f, 7.0f, 20.0f)
                horizontalLineTo(10.57f)
                curveTo(11.16f, 20.0f, 11.64f, 19.48f, 11.56f, 18.89f)
                ...
                curveTo(21.25f, 12.32f, 22.0f, 11.86f, 22.0f, 11.13f)
                verticalLineTo(8.0f)
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(18.0f, 13.0f)
                curveTo(15.24f, 13.0f, 13.0f, 15.23f, 13.0f, 18.0f)
                curveTo(13.0f, 20.76f, 15.24f, 23.0f, 18.0f, 23.0f)
                curveTo(20.77f, 23.0f, 23.0f, 20.76f, 23.0f, 18.0f)
                curveTo(23.0f, 15.23f, 20.77f, 13.0f, 18.0f, 13.0f)
                close()
