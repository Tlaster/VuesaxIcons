...
public val TwotoneGroup.Tetherusdt: ImageVector
    get() {
        if (_tetherusdt != null) {
            return _tetherusdt!!
        }
        _tetherusdt = Builder(name = "Tetherusdt", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _tetherusdt: ImageVector? = null
