...
public val BoldGroup.`Paperclip2-1`: ImageVector
    get() {
        if (`_paperclip2-1` != null) {
            return `_paperclip2-1`!!
        }
        `_paperclip2-1` = Builder(name = "Paperclip2-1", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.0f, 16.54f, 7.52f, 16.54f, 7.23f, 16.25f)
...
private var `_paperclip2-1`: ImageVector? = null
