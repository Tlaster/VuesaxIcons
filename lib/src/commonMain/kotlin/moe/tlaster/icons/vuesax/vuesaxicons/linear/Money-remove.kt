...
public val LinearGroup.`Money-remove`: ImageVector
    get() {
        if (`_money-remove` != null) {
            return `_money-remove`!!
        }
        `_money-remove` = Builder(name = "Money-remove", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(6.0712f, 19.0399f)
                lineTo(3.9612f, 16.9299f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(6.0399f, 16.96f)
                lineTo(3.9299f, 19.0699f)
            }
        }
        .build()
        return `_money-remove`!!
...
private var `_money-remove`: ImageVector? = null
