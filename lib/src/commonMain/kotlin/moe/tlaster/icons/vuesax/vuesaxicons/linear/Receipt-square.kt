...
public val LinearGroup.`Receipt-square`: ImageVector
    get() {
        if (`_receipt-square` != null) {
            return `_receipt-square`!!
        }
        `_receipt-square` = Builder(name = "Receipt-square", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_receipt-square`: ImageVector? = null
