...
public val LinearGroup.`Shapes-2`: ImageVector
    get() {
        if (`_shapes-2` != null) {
            return `_shapes-2`!!
        }
        `_shapes-2` = Builder(name = "Shapes-2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_shapes-2`: ImageVector? = null
