...
public val BoldGroup.`User-cirlce-add`: ImageVector
    get() {
        if (`_user-cirlce-add` != null) {
            return `_user-cirlce-add`!!
        }
        `_user-cirlce-add` = Builder(name = "User-cirlce-add", defaultWidth = 24.0.dp, defaultHeight
                = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(21.97f, 2.33f)
                curveTo(21.25f, 1.51f, 20.18f, 1.0f, 19.0f, 1.0f)
                curveTo(17.88f, 1.0f, 16.86f, 1.46f, 16.13f, 2.21f)
                curveTo(15.71f, 2.64f, 15.39f, 3.16f, 15.2f, 3.74f)
                curveTo(15.07f, 4.14f, 15.0f, 4.56f, 15.0f, 5.0f)
                curveTo(15.0f, 5.75f, 15.21f, 6.46f, 15.58f, 7.06f)
                curveTo(15.78f, 7.4f, 16.04f, 7.71f, 16.34f, 7.97f)
                curveTo(17.04f, 8.61f, 17.97f, 9.0f, 19.0f, 9.0f)
                curveTo(19.44f, 9.0f, 19.86f, 8.93f, 20.25f, 8.79f)
                curveTo(21.17f, 8.5f, 21.94f, 7.87f, 22.42f, 7.06f)
                curveTo(22.63f, 6.72f, 22.79f, 6.33f, 22.88f, 5.93f)
                curveTo(22.96f, 5.63f, 23.0f, 5.32f, 23.0f, 5.0f)
                curveTo(23.0f, 3.98f, 22.61f, 3.04f, 21.97f, 2.33f)
                close()
                moveTo(20.49f, 5.73f)
                horizontalLineTo(19.75f)
                verticalLineTo(6.51f)
                curveTo(19.75f, 6.92f, 19.41f, 7.26f, 19.0f, 7.26f)
                curveTo(18.59f, 7.26f, 18.25f, 6.92f, 18.25f, 6.51f)
                verticalLineTo(5.73f)
                horizontalLineTo(17.51f)
                curveTo(17.1f, 5.73f, 16.76f, 5.39f, 16.76f, 4.98f)
                curveTo(16.76f, 4.57f, 17.1f, 4.23f, 17.51f, 4.23f)
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(22.0f, 12.0f)
                curveTo(22.0f, 10.69f, 21.75f, 9.43f, 21.28f, 8.28f)
                curveTo(20.97f, 8.5f, 20.62f, 8.67f, 20.25f, 8.79f)
                curveTo(20.14f, 8.83f, 20.03f, 8.86f, 19.91f, 8.89f)
                curveTo(20.29f, 9.85f, 20.5f, 10.9f, 20.5f, 12.0f)
                ...
                curveTo(4.44f, 16.43f, 3.5f, 14.32f, 3.5f, 12.0f)
                curveTo(3.5f, 7.31f, 7.31f, 3.5f, 12.0f, 3.5f)
                curveTo(13.09f, 3.5f, 14.14f, 3.71f, 15.1f, 4.09f)
                curveTo(15.13f, 3.97f, 15.16f, 3.86f, 15.2f, 3.74f)
                curveTo(15.32f, 3.37f, 15.49f, 3.03f, 15.72f, 2.72f)
                curveTo(14.57f, 2.25f, 13.31f, 2.0f, 12.0f, 2.0f)
                curveTo(6.49f, 2.0f, 2.0f, 6.49f, 2.0f, 12.0f)
                curveTo(2.0f, 14.9f, 3.25f, 17.51f, 5.23f, 19.34f)
                ...
                curveTo(11.32f, 21.98f, 11.66f, 22.0f, 12.0f, 22.0f)
                curveTo(12.34f, 22.0f, 12.68f, 21.98f, 13.01f, 21.95f)
                ...
                curveTo(15.0f, 21.53f, 15.08f, 21.5f, 15.16f, 21.48f)
                ...
                curveTo(20.75f, 17.51f, 22.0f, 14.9f, 22.0f, 12.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(12.0f, 6.9297f)
                curveTo(9.93f, 6.9297f, 8.25f, 8.6097f, 8.25f, 10.6797f)
                curveTo(8.25f, 12.7097f, 9.84f, 14.3597f, 11.95f, 14.4197f)
                curveTo(11.98f, 14.4197f, 12.02f, 14.4197f, 12.04f, 14.4197f)
                curveTo(12.06f, 14.4197f, 12.09f, 14.4197f, 12.11f, 14.4197f)
                curveTo(12.12f, 14.4197f, 12.13f, 14.4197f, 12.13f, 14.4197f)
                curveTo(14.15f, 14.3497f, 15.74f, 12.7097f, 15.75f, 10.6797f)
                curveTo(15.75f, 8.6097f, 14.07f, 6.9297f, 12.0f, 6.9297f)
                close()
            }
        }
        .build()
...
private var `_user-cirlce-add`: ImageVector? = null
