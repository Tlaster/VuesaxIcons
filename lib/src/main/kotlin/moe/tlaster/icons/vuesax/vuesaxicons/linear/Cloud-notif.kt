...
public val LinearGroup.`Cloud-notif`: ImageVector
    get() {
        if (`_cloud-notif` != null) {
            return `_cloud-notif`!!
        }
        `_cloud-notif` = Builder(name = "Cloud-notif", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_cloud-notif`: ImageVector? = null
