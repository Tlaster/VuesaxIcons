...
public val LinearGroup.`Security-safe`: ImageVector
    get() {
        if (`_security-safe` != null) {
            return `_security-safe`!!
        }
        `_security-safe` = Builder(name = "Security-safe", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_security-safe`: ImageVector? = null
