...
public val LinearGroup.`Money-forbidden`: ImageVector
    get() {
        if (`_money-forbidden` != null) {
            return `_money-forbidden`!!
        }
        `_money-forbidden` = Builder(name = "Money-forbidden", defaultWidth = 24.0.dp, defaultHeight
...
private var `_money-forbidden`: ImageVector? = null
