...
public val LinearGroup.`Group-2`: ImageVector
    get() {
        if (`_group-2` != null) {
            return `_group-2`!!
        }
        `_group-2` = Builder(name = "Group-2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_group-2`: ImageVector? = null
