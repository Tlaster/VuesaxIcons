...
public val LinearGroup.`Music-playlist`: ImageVector
    get() {
        if (`_music-playlist` != null) {
            return `_music-playlist`!!
        }
        `_music-playlist` = Builder(name = "Music-playlist", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_music-playlist`: ImageVector? = null
