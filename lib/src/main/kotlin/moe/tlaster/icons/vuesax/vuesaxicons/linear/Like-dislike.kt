...
public val LinearGroup.`Like-dislike`: ImageVector
    get() {
        if (`_like-dislike` != null) {
            return `_like-dislike`!!
        }
        `_like-dislike` = Builder(name = "Like-dislike", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_like-dislike`: ImageVector? = null
