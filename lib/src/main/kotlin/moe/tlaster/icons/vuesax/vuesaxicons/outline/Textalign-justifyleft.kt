...
public val OutlineGroup.`Textalign-justifyleft`: ImageVector
    get() {
        if (`_textalign-justifyleft` != null) {
            return `_textalign-justifyleft`!!
        }
        `_textalign-justifyleft` = Builder(name = "Textalign-justifyleft", defaultWidth = 24.0.dp,
...
private var `_textalign-justifyleft`: ImageVector? = null
