...
public val BoldGroup.`Receipt-minus`: ImageVector
    get() {
        if (`_receipt-minus` != null) {
            return `_receipt-minus`!!
        }
        `_receipt-minus` = Builder(name = "Receipt-minus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_receipt-minus`: ImageVector? = null
