...
public val LinearGroup.`Directbox-notif`: ImageVector
    get() {
        if (`_directbox-notif` != null) {
            return `_directbox-notif`!!
        }
        `_directbox-notif` = Builder(name = "Directbox-notif", defaultWidth = 24.0.dp, defaultHeight
...
private var `_directbox-notif`: ImageVector? = null
