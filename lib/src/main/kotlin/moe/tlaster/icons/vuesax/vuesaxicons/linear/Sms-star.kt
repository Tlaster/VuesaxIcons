...
public val LinearGroup.`Sms-star`: ImageVector
    get() {
        if (`_sms-star` != null) {
            return `_sms-star`!!
        }
        `_sms-star` = Builder(name = "Sms-star", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_sms-star`: ImageVector? = null
