...
public val BoldGroup.`Arrow-swap`: ImageVector
    get() {
        if (`_arrow-swap` != null) {
            return `_arrow-swap`!!
        }
        `_arrow-swap` = Builder(name = "Arrow-swap", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(10.64f, 6.25f, 10.99f, 6.59f, 10.99f, 7.0f)
                ...
                curveTo(13.35f, 17.75f, 13.01f, 17.41f, 13.01f, 17.0f)
                verticalLineTo(7.0f)
...
private var `_arrow-swap`: ImageVector? = null
