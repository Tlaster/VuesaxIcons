...
public val LinearGroup.`User-add`: ImageVector
    get() {
        if (`_user-add` != null) {
            return `_user-add`!!
        }
        `_user-add` = Builder(name = "User-add", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_user-add`: ImageVector? = null
