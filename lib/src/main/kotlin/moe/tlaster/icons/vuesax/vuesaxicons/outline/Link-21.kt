...
public val OutlineGroup.`Link-21`: ImageVector
    get() {
        if (`_link-21` != null) {
            return `_link-21`!!
        }
        `_link-21` = Builder(name = "Link-21", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_link-21`: ImageVector? = null
