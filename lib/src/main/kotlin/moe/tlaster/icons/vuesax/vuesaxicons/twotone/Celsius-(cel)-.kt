...
public val TwotoneGroup.`Celsius-(cel)-`: ImageVector
    get() {
        ...
        `_celsius-(cel)-` = Builder(name = "Celsius-(cel)-", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(16.3296f, 15.2798f)
                curveTo(15.3396f, 16.5898f, 13.7596f, 17.4298f, 11.9996f, 17.4298f)
                curveTo(8.9996f, 17.4298f, 6.5596f, 14.9998f, 6.5596f, 11.9898f)
                curveTo(6.5596f, 8.9798f, 8.9896f, 6.5498f, 11.9996f, 6.5498f)
                curveTo(13.2296f, 6.5498f, 14.3596f, 6.9598f, 15.2696f, 7.6398f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    fillAlpha = 0.4f, strokeAlpha = 0.4f, strokeLineWidth = 1.5f, strokeLineCap =
                    Round, strokeLineJoin = StrokeJoin.Companion.Round, strokeLineMiter = 4.0f,
