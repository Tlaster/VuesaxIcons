...
public val LinearGroup.`Omega-circle-1`: ImageVector
    get() {
        if (`_omega-circle-1` != null) {
            return `_omega-circle-1`!!
        }
        `_omega-circle-1` = Builder(name = "Omega-circle-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_omega-circle-1`: ImageVector? = null
