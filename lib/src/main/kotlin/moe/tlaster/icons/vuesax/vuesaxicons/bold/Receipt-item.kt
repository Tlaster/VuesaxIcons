...
public val BoldGroup.`Receipt-item`: ImageVector
    get() {
        if (`_receipt-item` != null) {
            return `_receipt-item`!!
        }
        `_receipt-item` = Builder(name = "Receipt-item", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(8.25f, 12.6f, 8.59f, 12.26f, 9.0f, 12.26f)
                horizontalLineTo(12.0f)
                curveTo(12.41f, 12.26f, 12.75f, 12.6f, 12.75f, 13.01f)
                curveTo(12.75f, 13.42f, 12.41f, 13.76f, 12.0f, 13.76f)
                close()
                moveTo(12.0f, 9.76f)
                horizontalLineTo(9.0f)
                curveTo(8.59f, 9.76f, 8.25f, 9.42f, 8.25f, 9.01f)
                curveTo(8.25f, 8.6f, 8.59f, 8.26f, 9.0f, 8.26f)
                horizontalLineTo(12.0f)
                curveTo(12.41f, 8.26f, 12.75f, 8.6f, 12.75f, 9.01f)
                curveTo(12.75f, 9.42f, 12.41f, 9.76f, 12.0f, 9.76f)
                close()
            }
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
...
private var `_receipt-item`: ImageVector? = null
