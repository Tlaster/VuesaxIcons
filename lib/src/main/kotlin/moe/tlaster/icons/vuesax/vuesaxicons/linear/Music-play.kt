...
public val LinearGroup.`Music-play`: ImageVector
    get() {
        if (`_music-play` != null) {
            return `_music-play`!!
        }
        `_music-play` = Builder(name = "Music-play", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_music-play`: ImageVector? = null
