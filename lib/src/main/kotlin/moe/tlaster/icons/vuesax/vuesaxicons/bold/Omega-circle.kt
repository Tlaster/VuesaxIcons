...
public val BoldGroup.`Omega-circle`: ImageVector
    get() {
        if (`_omega-circle` != null) {
            return `_omega-circle`!!
        }
        `_omega-circle` = Builder(name = "Omega-circle", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(14.1f, 8.16f, 13.06f, 7.75f, 12.0f, 7.75f)
                ...
                curveTo(6.25f, 16.1f, 6.59f, 15.75f, 7.0f, 15.75f)
                horizontalLineTo(8.41f)
                lineTo(7.92f, 15.21f)
                curveTo(7.0f, 14.19f, 6.49f, 12.88f, 6.49f, 11.52f)
                curveTo(6.49f, 10.13f, 7.08f, 8.76f, 8.12f, 7.78f)
                curveTo(9.16f, 6.79f, 10.53f, 6.25f, 12.0f, 6.25f)
                curveTo(13.47f, 6.25f, 14.84f, 6.79f, 15.88f, 7.78f)
                curveTo(16.91f, 8.76f, 17.51f, 10.13f, 17.51f, 11.52f)
                curveTo(17.51f, 12.87f, 17.0f, 14.18f, 16.08f, 15.21f)
...
private var `_omega-circle`: ImageVector? = null
