...
public val LinearGroup.`Group-1`: ImageVector
    get() {
        if (`_group-1` != null) {
            return `_group-1`!!
        }
        `_group-1` = Builder(name = "Group-1", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_group-1`: ImageVector? = null
