...
public val LinearGroup.`Refresh-circle`: ImageVector
    get() {
        if (`_refresh-circle` != null) {
            return `_refresh-circle`!!
        }
        `_refresh-circle` = Builder(name = "Refresh-circle", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_refresh-circle`: ImageVector? = null
