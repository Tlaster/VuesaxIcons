...
public val LinearGroup.`Search-zoom-in`: ImageVector
    get() {
        if (`_search-zoom-in` != null) {
            return `_search-zoom-in`!!
        }
        `_search-zoom-in` = Builder(name = "Search-zoom-in", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_search-zoom-in`: ImageVector? = null
