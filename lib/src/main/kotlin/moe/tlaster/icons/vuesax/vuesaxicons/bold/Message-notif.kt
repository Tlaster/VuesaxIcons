...
public val BoldGroup.`Message-notif`: ImageVector
    get() {
        ...
        `_message-notif` = Builder(name = "Message-notif", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(20.0f, 6.75f)
                curveTo(21.5188f, 6.75f, 22.75f, 5.5188f, 22.75f, 4.0f)
                curveTo(22.75f, 2.4812f, 21.5188f, 1.25f, 20.0f, 1.25f)
                curveTo(18.4812f, 1.25f, 17.25f, 2.4812f, 17.25f, 4.0f)
                curveTo(17.25f, 5.5188f, 18.4812f, 6.75f, 20.0f, 6.75f)
                close()
            }
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                ...
                curveTo(15.95f, 2.58f, 15.49f, 2.0f, 14.85f, 2.0f)
                horizontalLineTo(7.0f)
                curveTo(4.24f, 2.0f, 2.0f, 4.24f, 2.0f, 7.0f)
                verticalLineTo(13.95f)
                curveTo(2.0f, 16.71f, 4.24f, 18.95f, 7.0f, 18.95f)
                ...
                curveTo(19.77f, 18.95f, 22.0f, 16.72f, 22.0f, 13.96f)
                verticalLineTo(9.15f)
                curveTo(22.0f, 8.52f, 21.42f, 8.06f, 20.8f, 8.18f)
                curveTo(20.24f, 8.28f, 19.65f, 8.28f, 19.04f, 8.15f)
                close()
                moveTo(8.0f, 12.0f)
                curveTo(7.44f, 12.0f, 7.0f, 11.55f, 7.0f, 11.0f)
                curveTo(7.0f, 10.45f, 7.44f, 10.0f, 8.0f, 10.0f)
                ...
                curveTo(11.0f, 10.45f, 11.44f, 10.0f, 12.0f, 10.0f)
                ...
                curveTo(15.0f, 10.45f, 15.44f, 10.0f, 16.0f, 10.0f)
