...
public val LinearGroup.`Main-component-1`: ImageVector
    get() {
        if (`_main-component-1` != null) {
            return `_main-component-1`!!
        }
        `_main-component-1` = Builder(name = "Main-component-1", defaultWidth = 24.0.dp,
...
private var `_main-component-1`: ImageVector? = null
