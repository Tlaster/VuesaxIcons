...
public val BoldGroup.`Radar-2`: ImageVector
    get() {
        if (`_radar-2` != null) {
            return `_radar-2`!!
        }
        `_radar-2` = Builder(name = "Radar-2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(8.72f, 10.98f)
                curveTo(8.62f, 11.31f, 8.55f, 11.65f, 8.55f, 12.0f)
                curveTo(8.55f, 13.9f, 10.1f, 15.45f, 12.0f, 15.45f)
                curveTo(13.9f, 15.45f, 15.45f, 13.9f, 15.45f, 12.0f)
                curveTo(15.45f, 10.1f, 13.9f, 8.55f, 12.0f, 8.55f)
                ...
                curveTo(10.55f, 7.21f, 11.26f, 7.05f, 12.0f, 7.05f)
                curveTo(14.73f, 7.05f, 16.95f, 9.27f, 16.95f, 12.0f)
                curveTo(16.95f, 14.73f, 14.73f, 16.95f, 12.0f, 16.95f)
                curveTo(9.27f, 16.95f, 7.05f, 14.73f, 7.05f, 12.0f)
