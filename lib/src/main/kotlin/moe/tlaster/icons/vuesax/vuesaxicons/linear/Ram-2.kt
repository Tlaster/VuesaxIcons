...
public val LinearGroup.`Ram-2`: ImageVector
    get() {
        if (`_ram-2` != null) {
            return `_ram-2`!!
        }
        `_ram-2` = Builder(name = "Ram-2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(8.9399f, 4.9501f)
                lineTo(8.9899f, 2.0601f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(11.9399f, 4.9501f)
                lineTo(11.9899f, 2.0601f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(14.9399f, 4.92f)
                lineTo(14.9899f, 2.04f)
            }
        }
        .build()
        return `_ram-2`!!
...
private var `_ram-2`: ImageVector? = null
