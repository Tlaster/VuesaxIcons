...
public val BoldGroup.`Hashtag-1`: ImageVector
    get() {
        if (`_hashtag-1` != null) {
            return `_hashtag-1`!!
        }
        `_hashtag-1` = Builder(name = "Hashtag-1", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(10.4199f, 13.4181f)
                horizontalLineTo(13.2599f)
                lineTo(13.5799f, 10.5781f)
                horizontalLineTo(10.7399f)
                lineTo(10.4199f, 13.4181f)
                close()
            }
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
