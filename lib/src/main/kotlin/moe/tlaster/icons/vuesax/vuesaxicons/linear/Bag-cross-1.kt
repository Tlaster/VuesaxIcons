...
public val LinearGroup.`Bag-cross-1`: ImageVector
    get() {
        if (`_bag-cross-1` != null) {
            return `_bag-cross-1`!!
        }
        `_bag-cross-1` = Builder(name = "Bag-cross-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_bag-cross-1`: ImageVector? = null
