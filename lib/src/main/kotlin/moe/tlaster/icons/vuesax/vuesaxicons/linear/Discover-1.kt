...
public val LinearGroup.`Discover-1`: ImageVector
    get() {
        if (`_discover-1` != null) {
            return `_discover-1`!!
        }
        `_discover-1` = Builder(name = "Discover-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_discover-1`: ImageVector? = null
