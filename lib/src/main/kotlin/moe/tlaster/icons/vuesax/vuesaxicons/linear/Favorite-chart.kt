...
public val LinearGroup.`Favorite-chart`: ImageVector
    get() {
        if (`_favorite-chart` != null) {
            return `_favorite-chart`!!
        }
        `_favorite-chart` = Builder(name = "Favorite-chart", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_favorite-chart`: ImageVector? = null
