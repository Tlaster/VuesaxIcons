...
public val BoldGroup.`Receipt-text`: ImageVector
    get() {
        if (`_receipt-text` != null) {
            return `_receipt-text`!!
        }
        `_receipt-text` = Builder(name = "Receipt-text", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_receipt-text`: ImageVector? = null
