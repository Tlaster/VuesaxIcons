...
public val LinearGroup.`Money-change`: ImageVector
    get() {
        if (`_money-change` != null) {
            return `_money-change`!!
        }
        `_money-change` = Builder(name = "Money-change", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_money-change`: ImageVector? = null
