...
public val LinearGroup.`Mouse-1`: ImageVector
    get() {
        if (`_mouse-1` != null) {
            return `_mouse-1`!!
        }
        `_mouse-1` = Builder(name = "Mouse-1", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_mouse-1`: ImageVector? = null
