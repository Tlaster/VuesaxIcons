...
public val LinearGroup.`Format-circle`: ImageVector
    get() {
        ...
        `_format-circle` = Builder(name = "Format-circle", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    ...
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(21.5f, 18.65f)
                curveTo(21.5f, 20.23f, 20.23f, 21.5f, 18.65f, 21.5f)
                curveTo(17.74f, 21.5f, 16.93f, 21.07f, 16.42f, 20.41f)
                horizontalLineTo(16.41f)
                curveTo(16.03f, 19.93f, 15.8f, 19.32f, 15.8f, 18.65f)
                curveTo(15.8f, 17.07f, 17.07f, 15.8f, 18.65f, 15.8f)
                curveTo(19.32f, 15.8f, 19.92f, 16.03f, 20.41f, 16.41f)
                verticalLineTo(16.42f)
                curveTo(21.07f, 16.93f, 21.5f, 17.74f, 21.5f, 18.65f)
                close()
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
