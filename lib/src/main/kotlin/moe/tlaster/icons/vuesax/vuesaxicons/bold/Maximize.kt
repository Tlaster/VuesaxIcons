    ...
    get() {
        ...
        _maximize = Builder(name = "Maximize", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(5.47f, 2.0f, 3.0f, 4.47f, 3.0f, 7.52f)
                verticalLineTo(10.5f)
                curveTo(3.0f, 11.05f, 3.45f, 11.5f, 4.0f, 11.5f)
                horizontalLineTo(8.5f)
                curveTo(10.71f, 11.5f, 12.5f, 13.29f, 12.5f, 15.5f)
                verticalLineTo(20.0f)
                curveTo(12.5f, 20.55f, 12.95f, 21.0f, 13.5f, 21.0f)
                horizontalLineTo(16.48f)
                curveTo(19.93f, 21.0f, 22.0f, 18.94f, 22.0f, 15.48f)
                verticalLineTo(7.52f)
                curveTo(22.0f, 4.47f, 19.53f, 2.0f, 16.48f, 2.0f)
                close()
                moveTo(18.76f, 9.99f)
                ...
                curveTo(13.25f, 5.56f, 13.58f, 5.22f, 14.0f, 5.22f)
