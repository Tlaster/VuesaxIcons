...
public val LinearGroup.`Forward-10-seconds`: ImageVector
    get() {
        if (`_forward-10-seconds` != null) {
            return `_forward-10-seconds`!!
        }
        `_forward-10-seconds` = Builder(name = "Forward-10-seconds", defaultWidth = 24.0.dp,
...
private var `_forward-10-seconds`: ImageVector? = null
