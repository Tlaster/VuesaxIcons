...
public val BrokenGroup.`Shapes-1`: ImageVector
    get() {
        if (`_shapes-1` != null) {
            return `_shapes-1`!!
        }
        `_shapes-1` = Builder(name = "Shapes-1", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_shapes-1`: ImageVector? = null
