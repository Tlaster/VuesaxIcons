...
public val OutlineGroup.`Textalign-justifyright`: ImageVector
    get() {
        if (`_textalign-justifyright` != null) {
            return `_textalign-justifyright`!!
        }
        `_textalign-justifyright` = Builder(name = "Textalign-justifyright", defaultWidth = 24.0.dp,
...
private var `_textalign-justifyright`: ImageVector? = null
