...
public val BoldGroup.`Textalign-justifyleft-1`: ImageVector
    get() {
        if (`_textalign-justifyleft-1` != null) {
            return `_textalign-justifyleft-1`!!
        }
        `_textalign-justifyleft-1` = Builder(name = "Textalign-justifyleft-1", defaultWidth =
...
private var `_textalign-justifyleft-1`: ImageVector? = null
