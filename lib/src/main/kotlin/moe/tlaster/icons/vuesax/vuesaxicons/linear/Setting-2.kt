...
public val LinearGroup.`Setting-2`: ImageVector
    get() {
        if (`_setting-2` != null) {
            return `_setting-2`!!
        }
        `_setting-2` = Builder(name = "Setting-2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_setting-2`: ImageVector? = null
