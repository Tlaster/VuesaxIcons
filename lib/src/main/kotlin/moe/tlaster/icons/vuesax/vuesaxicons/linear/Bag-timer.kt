...
public val LinearGroup.`Bag-timer`: ImageVector
    get() {
        if (`_bag-timer` != null) {
            return `_bag-timer`!!
        }
        `_bag-timer` = Builder(name = "Bag-timer", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_bag-timer`: ImageVector? = null
