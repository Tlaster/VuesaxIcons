...
public val LinearGroup.`Rotate-left`: ImageVector
    get() {
        if (`_rotate-left` != null) {
            return `_rotate-left`!!
        }
        `_rotate-left` = Builder(name = "Rotate-left", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_rotate-left`: ImageVector? = null
