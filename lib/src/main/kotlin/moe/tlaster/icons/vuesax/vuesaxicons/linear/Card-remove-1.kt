...
public val LinearGroup.`Card-remove-1`: ImageVector
    get() {
        if (`_card-remove-1` != null) {
            return `_card-remove-1`!!
        }
        `_card-remove-1` = Builder(name = "Card-remove-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_card-remove-1`: ImageVector? = null
