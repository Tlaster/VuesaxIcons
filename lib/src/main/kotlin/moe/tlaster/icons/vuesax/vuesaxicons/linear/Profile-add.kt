...
public val LinearGroup.`Profile-add`: ImageVector
    get() {
        if (`_profile-add` != null) {
            return `_profile-add`!!
        }
        `_profile-add` = Builder(name = "Profile-add", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_profile-add`: ImageVector? = null
