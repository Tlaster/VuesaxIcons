...
public val LinearGroup.`Save-minus`: ImageVector
    get() {
        if (`_save-minus` != null) {
            return `_save-minus`!!
        }
        `_save-minus` = Builder(name = "Save-minus", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_save-minus`: ImageVector? = null
