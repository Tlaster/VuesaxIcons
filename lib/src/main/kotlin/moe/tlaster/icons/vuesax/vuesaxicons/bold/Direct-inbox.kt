...
public val BoldGroup.`Direct-inbox`: ImageVector
    get() {
        if (`_direct-inbox` != null) {
            return `_direct-inbox`!!
        }
        `_direct-inbox` = Builder(name = "Direct-inbox", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(2.0f, 6.17f, 4.17f, 4.0f, 7.81f, 4.0f)
                ...
                curveTo(11.81f, 9.73f, 11.9f, 9.75f, 12.0f, 9.75f)
                ...
                curveTo(19.83f, 4.0f, 22.0f, 6.17f, 22.0f, 9.81f)
                close()
            }
        }
        .build()
...
private var `_direct-inbox`: ImageVector? = null
