...
public val LinearGroup.`Gallery-remove`: ImageVector
    get() {
        if (`_gallery-remove` != null) {
            return `_gallery-remove`!!
        }
        `_gallery-remove` = Builder(name = "Gallery-remove", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                moveTo(16.5601f, 6.9401f)
                lineTo(20.4401f, 3.0601f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(20.4401f, 6.9401f)
                lineTo(16.5601f, 3.0601f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
...
private var `_gallery-remove`: ImageVector? = null
