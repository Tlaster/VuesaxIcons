...
public val LinearGroup.`Omega-square-1`: ImageVector
    get() {
        if (`_omega-square-1` != null) {
            return `_omega-square-1`!!
        }
        `_omega-square-1` = Builder(name = "Omega-square-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_omega-square-1`: ImageVector? = null
