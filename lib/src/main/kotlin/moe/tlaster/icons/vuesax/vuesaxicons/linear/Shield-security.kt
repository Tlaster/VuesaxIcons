...
public val LinearGroup.`Shield-security`: ImageVector
    get() {
        if (`_shield-security` != null) {
            return `_shield-security`!!
        }
        `_shield-security` = Builder(name = "Shield-security", defaultWidth = 24.0.dp, defaultHeight
...
private var `_shield-security`: ImageVector? = null
