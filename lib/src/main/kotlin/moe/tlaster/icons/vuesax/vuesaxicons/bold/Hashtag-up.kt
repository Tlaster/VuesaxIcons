...
public val BoldGroup.`Hashtag-up`: ImageVector
    get() {
        if (`_hashtag-up` != null) {
            return `_hashtag-up`!!
        }
        `_hashtag-up` = Builder(name = "Hashtag-up", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_hashtag-up`: ImageVector? = null
