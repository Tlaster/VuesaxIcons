...
public val LinearGroup.`Align-horizontally`: ImageVector
    get() {
        if (`_align-horizontally` != null) {
            return `_align-horizontally`!!
        }
        `_align-horizontally` = Builder(name = "Align-horizontally", defaultWidth = 24.0.dp,
...
private var `_align-horizontally`: ImageVector? = null
