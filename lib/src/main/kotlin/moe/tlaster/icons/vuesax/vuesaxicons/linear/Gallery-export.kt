...
public val LinearGroup.`Gallery-export`: ImageVector
    get() {
        if (`_gallery-export` != null) {
            return `_gallery-export`!!
        }
        `_gallery-export` = Builder(name = "Gallery-export", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_gallery-export`: ImageVector? = null
