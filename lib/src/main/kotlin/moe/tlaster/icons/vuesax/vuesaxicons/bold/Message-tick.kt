...
public val BoldGroup.`Message-tick`: ImageVector
    get() {
        if (`_message-tick` != null) {
            return `_message-tick`!!
        }
        `_message-tick` = Builder(name = "Message-tick", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(2.27f, 20.72f, 3.54f, 21.5f, 5.0f, 21.5f)
...
private var `_message-tick`: ImageVector? = null
