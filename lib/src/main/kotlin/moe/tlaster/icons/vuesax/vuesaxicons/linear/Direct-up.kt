...
public val LinearGroup.`Direct-up`: ImageVector
    get() {
        if (`_direct-up` != null) {
            return `_direct-up`!!
        }
        `_direct-up` = Builder(name = "Direct-up", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_direct-up`: ImageVector? = null
