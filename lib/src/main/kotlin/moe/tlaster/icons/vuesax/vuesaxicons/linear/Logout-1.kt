...
public val LinearGroup.`Logout-1`: ImageVector
    get() {
        if (`_logout-1` != null) {
            return `_logout-1`!!
        }
        `_logout-1` = Builder(name = "Logout-1", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_logout-1`: ImageVector? = null
