...
public val LinearGroup.`Lamp-on`: ImageVector
    get() {
        if (`_lamp-on` != null) {
            return `_lamp-on`!!
        }
        `_lamp-on` = Builder(name = "Lamp-on", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_lamp-on`: ImageVector? = null
