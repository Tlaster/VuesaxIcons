...
public val BoldGroup.`Textalign-justifyright-1`: ImageVector
    get() {
        if (`_textalign-justifyright-1` != null) {
            return `_textalign-justifyright-1`!!
        }
        `_textalign-justifyright-1` = Builder(name = "Textalign-justifyright-1", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(11.25f, 4.09f, 11.59f, 3.75f, 12.0f, 3.75f)
...
private var `_textalign-justifyright-1`: ImageVector? = null
