...
public val LinearGroup.`Gallery-add`: ImageVector
    get() {
        if (`_gallery-add` != null) {
            return `_gallery-add`!!
        }
        `_gallery-add` = Builder(name = "Gallery-add", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_gallery-add`: ImageVector? = null
