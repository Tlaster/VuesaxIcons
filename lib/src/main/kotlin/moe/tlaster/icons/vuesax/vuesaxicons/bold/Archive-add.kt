...
public val BoldGroup.`Archive-add`: ImageVector
    get() {
        if (`_archive-add` != null) {
            return `_archive-add`!!
        }
        `_archive-add` = Builder(name = "Archive-add", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(12.7503f, 13.62f, 12.4103f, 13.96f, 12.0003f, 13.96f)
                curveTo(11.5903f, 13.96f, 11.2503f, 13.62f, 11.2503f, 13.21f)
                ...
                curveTo(11.2503f, 7.8f, 11.5903f, 7.46f, 12.0003f, 7.46f)
                curveTo(12.4103f, 7.46f, 12.7503f, 7.8f, 12.7503f, 8.21f)
                verticalLineTo(9.9f)
...
private var `_archive-add`: ImageVector? = null
