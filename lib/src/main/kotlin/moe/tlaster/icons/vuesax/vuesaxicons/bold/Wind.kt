    ...
    get() {
        ...
        _wind = Builder(name = "Wind", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(9.31f, 9.7511f)
                horizontalLineTo(2.0f)
                curveTo(1.59f, 9.7511f, 1.25f, 9.4111f, 1.25f, 9.0011f)
                curveTo(1.25f, 8.5911f, 1.59f, 8.2511f, 2.0f, 8.2511f)
                horizontalLineTo(9.31f)
                curveTo(10.38f, 8.2511f, 11.25f, 7.3811f, 11.25f, 6.3111f)
                curveTo(11.25f, 5.2411f, 10.38f, 4.3711f, 9.31f, 4.3711f)
                curveTo(8.24f, 4.3711f, 7.37f, 5.2411f, 7.37f, 6.3111f)
                verticalLineTo(6.6911f)
                curveTo(7.37f, 7.1011f, 7.03f, 7.4411f, 6.62f, 7.4411f)
                curveTo(6.21f, 7.4411f, 5.87f, 7.1111f, 5.87f, 6.6911f)
                verticalLineTo(6.3111f)
                curveTo(5.87f, 4.4111f, 7.41f, 2.8711f, 9.31f, 2.8711f)
                curveTo(11.21f, 2.8711f, 12.75f, 4.4111f, 12.75f, 6.3111f)
                curveTo(12.75f, 8.2111f, 11.21f, 9.7511f, 9.31f, 9.7511f)
                close()
            }
        }
        .build()
