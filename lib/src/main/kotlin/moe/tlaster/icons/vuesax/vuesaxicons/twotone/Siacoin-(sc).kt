...
public val TwotoneGroup.`Siacoin-(sc)`: ImageVector
    get() {
        if (`_siacoin-(sc)` != null) {
            return `_siacoin-(sc)`!!
        }
        `_siacoin-(sc)` = Builder(name = "Siacoin-(sc)", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_siacoin-(sc)`: ImageVector? = null
