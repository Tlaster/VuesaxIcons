...
public val LinearGroup.`Scissor-1`: ImageVector
    get() {
        if (`_scissor-1` != null) {
            return `_scissor-1`!!
        }
        `_scissor-1` = Builder(name = "Scissor-1", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_scissor-1`: ImageVector? = null
