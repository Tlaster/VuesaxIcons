...
public val BoldGroup.`Creative-commons`: ImageVector
    get() {
        ...
        `_creative-commons` = Builder(name = "Creative-commons", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(8.99f, 14.12f)
                curveTo(9.5f, 14.12f, 10.0f, 13.93f, 10.39f, 13.59f)
                ...
                curveTo(6.99f, 15.62f, 5.37f, 14.0f, 5.37f, 12.0f)
                curveTo(5.37f, 10.0f, 6.99f, 8.38f, 8.99f, 8.38f)
                ...
                curveTo(10.0f, 10.07f, 9.5f, 9.88f, 8.99f, 9.88f)
                curveTo(7.82f, 9.88f, 6.87f, 10.83f, 6.87f, 12.0f)
                curveTo(6.87f, 13.17f, 7.82f, 14.12f, 8.99f, 14.12f)
                close()
                moveTo(15.99f, 14.12f)
                curveTo(16.5f, 14.12f, 17.0f, 13.93f, 17.39f, 13.59f)
                ...
                curveTo(13.99f, 15.62f, 12.37f, 14.0f, 12.37f, 12.0f)
                curveTo(12.37f, 10.0f, 13.99f, 8.38f, 15.99f, 8.38f)
                ...
                curveTo(17.0f, 10.07f, 16.51f, 9.88f, 15.99f, 9.88f)
                curveTo(14.82f, 9.88f, 13.87f, 10.83f, 13.87f, 12.0f)
