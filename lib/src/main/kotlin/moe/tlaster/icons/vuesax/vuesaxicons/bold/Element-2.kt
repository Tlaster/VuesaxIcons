...
public val BoldGroup.`Element-2`: ImageVector
    get() {
        if (`_element-2` != null) {
            return `_element-2`!!
        }
        `_element-2` = Builder(name = "Element-2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_element-2`: ImageVector? = null
