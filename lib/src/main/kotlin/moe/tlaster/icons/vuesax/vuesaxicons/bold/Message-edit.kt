...
public val BoldGroup.`Message-edit`: ImageVector
    get() {
        if (`_message-edit` != null) {
            return `_message-edit`!!
        }
        `_message-edit` = Builder(name = "Message-edit", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(12.18f, 11.0f, 12.22f, 11.04f, 12.23f, 11.06f)
                curveTo(12.45f, 11.31f, 12.68f, 11.55f, 12.9f, 11.73f)
                curveTo(12.96f, 11.79f, 13.0f, 11.82f, 13.01f, 11.83f)
...
private var `_message-edit`: ImageVector? = null
