...
public val LinearGroup.`Card-send`: ImageVector
    get() {
        if (`_card-send` != null) {
            return `_card-send`!!
        }
        `_card-send` = Builder(name = "Card-send", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_card-send`: ImageVector? = null
