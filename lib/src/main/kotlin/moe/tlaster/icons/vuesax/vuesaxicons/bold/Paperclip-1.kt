...
public val BoldGroup.`Paperclip-1`: ImageVector
    get() {
        if (`_paperclip-1` != null) {
            return `_paperclip-1`!!
        }
        `_paperclip-1` = Builder(name = "Paperclip-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_paperclip-1`: ImageVector? = null
