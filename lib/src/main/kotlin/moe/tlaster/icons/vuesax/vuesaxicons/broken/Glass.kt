...
public val BrokenGroup.Glass: ImageVector
    get() {
        if (_glass != null) {
            return _glass!!
        }
        _glass = Builder(name = "Glass", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                lineTo(6.5708f, 11.69f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                    strokeLineWidth = 1.5f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(5.9394f, 13.1201f)
                curveTo(5.9394f, 13.1201f, 8.9994f, 13.0001f, 11.9995f, 14.0001f)
                curveTo(14.9995f, 15.0001f, 17.8295f, 13.1101f, 17.8295f, 13.1101f)
            }
        }
        .build()
        return _glass!!
