...
public val BoldGroup.`Wifi-square`: ImageVector
    get() {
        if (`_wifi-square` != null) {
            return `_wifi-square`!!
        }
        `_wifi-square` = Builder(name = "Wifi-square", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(7.73f, 13.9f, 7.26f, 13.84f, 7.0f, 13.51f)
                curveTo(6.74f, 13.18f, 6.81f, 12.71f, 7.13f, 12.46f)
                curveTo(10.08f, 10.18f, 13.9f, 10.18f, 16.85f, 12.46f)
                curveTo(17.19f, 12.71f, 17.25f, 13.18f, 17.0f, 13.51f)
                close()
                moveTo(18.59f, 10.42f)
                curveTo(18.44f, 10.61f, 18.22f, 10.71f, 18.0f, 10.71f)
...
private var `_wifi-square`: ImageVector? = null
