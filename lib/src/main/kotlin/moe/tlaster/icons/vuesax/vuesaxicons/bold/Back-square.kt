...
public val BoldGroup.`Back-square`: ImageVector
    get() {
        if (`_back-square` != null) {
            return `_back-square`!!
        }
        `_back-square` = Builder(name = "Back-square", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_back-square`: ImageVector? = null
