...
public val LinearGroup.`Group-11`: ImageVector
    get() {
        if (`_group-11` != null) {
            return `_group-11`!!
        }
        `_group-11` = Builder(name = "Group-11", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_group-11`: ImageVector? = null
