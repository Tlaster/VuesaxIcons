...
public val LinearGroup.`Ticket-2`: ImageVector
    get() {
        if (`_ticket-2` != null) {
            return `_ticket-2`!!
        }
        `_ticket-2` = Builder(name = "Ticket-2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_ticket-2`: ImageVector? = null
