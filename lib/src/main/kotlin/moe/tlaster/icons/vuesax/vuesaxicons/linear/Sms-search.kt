...
public val LinearGroup.`Sms-search`: ImageVector
    get() {
        if (`_sms-search` != null) {
            return `_sms-search`!!
        }
        `_sms-search` = Builder(name = "Sms-search", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_sms-search`: ImageVector? = null
