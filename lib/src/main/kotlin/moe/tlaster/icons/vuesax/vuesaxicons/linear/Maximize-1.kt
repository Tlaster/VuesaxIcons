...
public val LinearGroup.`Maximize-1`: ImageVector
    get() {
        if (`_maximize-1` != null) {
            return `_maximize-1`!!
        }
        `_maximize-1` = Builder(name = "Maximize-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_maximize-1`: ImageVector? = null
