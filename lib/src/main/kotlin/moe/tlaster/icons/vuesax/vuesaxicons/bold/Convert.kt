    ...
    get() {
        ...
        _convert = Builder(name = "Convert", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(10.0812f, 2.0313f, 8.2612f, 2.5912f, 6.7312f, 3.5512f)
                ...
                curveTo(15.0913f, 12.5412f, 14.9013f, 12.8113f, 14.6213f, 12.9213f)
                curveTo(14.5313f, 12.9613f, 14.4313f, 12.9812f, 14.3413f, 12.9812f)
                ...
                curveTo(2.0313f, 17.5512f, 6.5113f, 22.0312f, 12.0312f, 22.0312f)
                curveTo(13.9813f, 22.0312f, 15.8013f, 21.4712f, 17.3313f, 20.5112f)
                ...
                curveTo(8.9712f, 11.5213f, 9.1613f, 11.2513f, 9.4412f, 11.1413f)
                curveTo(9.7113f, 11.0213f, 10.0413f, 11.0813f, 10.2513f, 11.3013f)
                lineTo(18.4412f, 19.5012f)
                curveTo(18.4812f, 19.5412f, 18.5113f, 19.5813f, 18.5413f, 19.6213f)
                curveTo(20.6813f, 17.7813f, 22.0312f, 15.0612f, 22.0312f, 12.0312f)
                curveTo(22.0312f, 6.5113f, 17.5512f, 2.0313f, 12.0312f, 2.0313f)
                close()
            }
        }
        .build()
