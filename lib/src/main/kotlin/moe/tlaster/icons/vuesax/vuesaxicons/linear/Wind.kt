...
public val LinearGroup.Wind: ImageVector
    get() {
        if (_wind != null) {
            return _wind!!
        }
        _wind = Builder(name = "Wind", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                curveTo(10.8f, 9.0f, 12.0f, 7.79f, 12.0f, 6.31f)
                curveTo(12.0f, 4.82f, 10.79f, 3.62f, 9.31f, 3.62f)
                curveTo(7.82f, 3.62f, 6.62f, 4.83f, 6.62f, 6.31f)
