...
public val LinearGroup.`Ranking-1`: ImageVector
    get() {
        if (`_ranking-1` != null) {
            return `_ranking-1`!!
        }
        `_ranking-1` = Builder(name = "Ranking-1", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_ranking-1`: ImageVector? = null
