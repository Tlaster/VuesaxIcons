...
public val LinearGroup.`Arrow-square`: ImageVector
    get() {
        if (`_arrow-square` != null) {
            return `_arrow-square`!!
        }
        `_arrow-square` = Builder(name = "Arrow-square", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_arrow-square`: ImageVector? = null
