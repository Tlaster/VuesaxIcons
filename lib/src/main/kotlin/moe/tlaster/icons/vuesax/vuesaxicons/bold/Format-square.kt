...
public val BoldGroup.`Format-square`: ImageVector
    get() {
        ...
        `_format-square` = Builder(name = "Format-square", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(20.75f, 16.5f)
                verticalLineTo(7.5f)
                curveTo(21.94f, 7.0f, 22.75f, 5.83f, 22.75f, 4.5f)
                curveTo(22.75f, 2.71f, 21.29f, 1.25f, 19.5f, 1.25f)
                curveTo(18.18f, 1.25f, 17.0f, 2.06f, 16.5f, 3.25f)
                horizontalLineTo(7.5f)
                curveTo(7.0f, 2.06f, 5.83f, 1.25f, 4.5f, 1.25f)
                curveTo(2.71f, 1.25f, 1.25f, 2.71f, 1.25f, 4.5f)
                curveTo(1.25f, 5.82f, 2.06f, 7.0f, 3.25f, 7.5f)
                verticalLineTo(16.5f)
                curveTo(2.06f, 17.0f, 1.25f, 18.17f, 1.25f, 19.5f)
                curveTo(1.25f, 21.29f, 2.71f, 22.75f, 4.5f, 22.75f)
                curveTo(5.82f, 22.75f, 7.0f, 21.94f, 7.5f, 20.75f)
                horizontalLineTo(16.5f)
                curveTo(17.0f, 21.94f, 18.17f, 22.75f, 19.5f, 22.75f)
                curveTo(21.29f, 22.75f, 22.75f, 21.29f, 22.75f, 19.5f)
                curveTo(22.75f, 18.18f, 21.94f, 17.0f, 20.75f, 16.5f)
                close()
                moveTo(19.16f, 16.27f)
                curveTo(19.05f, 16.28f, 18.95f, 16.3f, 18.84f, 16.32f)
                curveTo(18.57f, 16.37f, 18.31f, 16.46f, 18.06f, 16.59f)
                curveTo(18.0f, 16.62f, 17.94f, 16.65f, 17.88f, 16.69f)
                curveTo(17.38f, 16.97f, 16.97f, 17.38f, 16.69f, 17.88f)
                curveTo(16.65f, 17.94f, 16.62f, 18.0f, 16.59f, 18.06f)
                ...
                curveTo(6.0f, 7.38f, 6.06f, 7.35f, 6.12f, 7.31f)
                curveTo(6.62f, 7.03f, 7.03f, 6.62f, 7.31f, 6.12f)
                curveTo(7.35f, 6.06f, 7.38f, 6.0f, 7.41f, 5.94f)
                ...
                curveTo(16.62f, 6.0f, 16.65f, 6.06f, 16.69f, 6.12f)
                curveTo(16.97f, 6.62f, 17.38f, 7.03f, 17.88f, 7.31f)
                curveTo(17.94f, 7.35f, 18.0f, 7.38f, 18.06f, 7.41f)
