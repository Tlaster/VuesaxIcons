...
public val LinearGroup.`Receipt-1`: ImageVector
    get() {
        if (`_receipt-1` != null) {
            return `_receipt-1`!!
        }
        `_receipt-1` = Builder(name = "Receipt-1", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_receipt-1`: ImageVector? = null
