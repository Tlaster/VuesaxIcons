...
public val LinearGroup.`Money-4`: ImageVector
    get() {
        if (`_money-4` != null) {
            return `_money-4`!!
        }
        `_money-4` = Builder(name = "Money-4", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_money-4`: ImageVector? = null
