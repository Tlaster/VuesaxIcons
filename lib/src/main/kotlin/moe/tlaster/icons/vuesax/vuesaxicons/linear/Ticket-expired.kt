...
public val LinearGroup.`Ticket-expired`: ImageVector
    get() {
        if (`_ticket-expired` != null) {
            return `_ticket-expired`!!
        }
        `_ticket-expired` = Builder(name = "Ticket-expired", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_ticket-expired`: ImageVector? = null
