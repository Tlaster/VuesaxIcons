...
public val TwotoneGroup.`Wanchain-(wan)`: ImageVector
    get() {
        if (`_wanchain-(wan)` != null) {
            return `_wanchain-(wan)`!!
        }
        `_wanchain-(wan)` = Builder(name = "Wanchain-(wan)", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_wanchain-(wan)`: ImageVector? = null
