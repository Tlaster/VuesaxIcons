...
public val LinearGroup.`Transaction-minus`: ImageVector
    get() {
        if (`_transaction-minus` != null) {
            return `_transaction-minus`!!
        }
        `_transaction-minus` = Builder(name = "Transaction-minus", defaultWidth = 24.0.dp,
...
private var `_transaction-minus`: ImageVector? = null
