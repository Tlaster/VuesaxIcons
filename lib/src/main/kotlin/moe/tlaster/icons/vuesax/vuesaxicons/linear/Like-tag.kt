...
public val LinearGroup.`Like-tag`: ImageVector
    get() {
        if (`_like-tag` != null) {
            return `_like-tag`!!
        }
        `_like-tag` = Builder(name = "Like-tag", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var `_like-tag`: ImageVector? = null
