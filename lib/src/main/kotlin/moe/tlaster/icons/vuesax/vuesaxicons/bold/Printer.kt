    ...
    get() {
        ...
        _printer = Builder(name = "Printer", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(17.0f, 5.55f, 16.55f, 6.0f, 16.0f, 6.0f)
                horizontalLineTo(8.0f)
                curveTo(7.45f, 6.0f, 7.0f, 5.55f, 7.0f, 5.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
            ...
            path(fill = SolidColor(Color(0xFF292D32)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(6.7202f, 18.0f, 7.0f, 17.7202f, 7.0f, 17.375f)
                verticalLineTo(17.375f)
                curveTo(7.0f, 17.0298f, 6.7113f, 16.7604f, 6.3884f, 16.6384f)
                curveTo(5.7262f, 16.3882f, 5.25f, 15.7453f, 5.25f, 15.0f)
                curveTo(5.25f, 14.04f, 6.04f, 13.25f, 7.0f, 13.25f)
                horizontalLineTo(17.0f)
                curveTo(17.96f, 13.25f, 18.75f, 14.04f, 18.75f, 15.0f)
                curveTo(18.75f, 15.7453f, 18.2738f, 16.3882f, 17.6116f, 16.6384f)
                curveTo(17.2887f, 16.7604f, 17.0f, 17.0298f, 17.0f, 17.375f)
                verticalLineTo(17.375f)
                curveTo(17.0f, 17.7202f, 17.2798f, 18.0f, 17.625f, 18.0f)
