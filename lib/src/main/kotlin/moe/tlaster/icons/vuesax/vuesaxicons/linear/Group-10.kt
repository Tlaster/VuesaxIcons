...
public val LinearGroup.`Group-10`: ImageVector
    get() {
        if (`_group-10` != null) {
            return `_group-10`!!
        }
        `_group-10` = Builder(name = "Group-10", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF292D32)),
                ...
                curveTo(12.44f, 10.51f, 12.0f, 10.07f, 12.0f, 8.31f)
                verticalLineTo(4.2f)
...
private var `_group-10`: ImageVector? = null
