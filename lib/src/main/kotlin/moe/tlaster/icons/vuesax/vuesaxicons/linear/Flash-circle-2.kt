...
public val LinearGroup.`Flash-circle-2`: ImageVector
    get() {
        if (`_flash-circle-2` != null) {
            return `_flash-circle-2`!!
        }
        `_flash-circle-2` = Builder(name = "Flash-circle-2", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_flash-circle-2`: ImageVector? = null
