...
public val BoldGroup.`Forbidden-2`: ImageVector
    get() {
        if (`_forbidden-2` != null) {
            return `_forbidden-2`!!
        }
        `_forbidden-2` = Builder(name = "Forbidden-2", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_forbidden-2`: ImageVector? = null
