...
public val LinearGroup.`Finger-cricle`: ImageVector
    get() {
        if (`_finger-cricle` != null) {
            return `_finger-cricle`!!
        }
        `_finger-cricle` = Builder(name = "Finger-cricle", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_finger-cricle`: ImageVector? = null
